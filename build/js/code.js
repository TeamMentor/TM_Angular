...
(function() {
  ...
  app.run(function($templateCache) {
    ...
    $templateCache.put('/angular/jade-html/component/navigation/left_navigation', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><aside ng-controller=\"User_Navigation_Controller\"><ul><li><div class=\"logo\"></div></li><li ng-show=\"show_Loading_Image\"><img src=\"http://v1.preloaders.net/preloaders/98/preview.gif\" style=\"height:15px;width:15px\"/></li><li><a ui-sref=\"main\"><icon class=\"Home\"></icon></a></li><li><!--a(ui-sref=\"queries\")--><a href=\"#\" ng-click=\"open_Query_State()\"><icon class=\"Index\"></icon></a></li><li><a ui-sref=\"docs\"><icon class=\"Info\"></icon></a></li><li><a href=\"/angular/guest/home\"><icon class=\"Logout\"></icon></a><!--a(ui-sref=\"logout\")--></li></ul></aside>");
    ...
    $templateCache.put('/angular/jade-html/component/user/pagination', "<span ng-controller=\"Pagination_Controller\"><div ng-show=\"model.pages\" class=\"section row pagination\"><div class=\"previous\"><a href=\"#\" ng-click=\"previous_Page()\"><span class=\"icon-Arrow-Left\"></span><span> previous</span></a></div><div id=\"current_Page\" class=\"number\"><select ng-model=\"model.page\" ng-change=\"set_Page()\" ng-options=\"page for page in model.pages\"></select></div><div id=\"page_Splits\" class=\"number\"><select ng-model=\"model.page_Split\" ng-change=\"set_Page_Split()\" ng-options=\"page_Split for page_Split in model.page_Splits\"></select></div><div class=\"next\"><a href=\"#\" ng-click=\"next_Page()\"><span>next </span><span class=\"icon-Arrow-Right\"></span></a></div></div></span>");
    ...
    $templateCache.put('/angular/jade-html/component/user/results', "<div ng-controller=\"Results_Controller\"><section ng-hide=\"results_Size\" class=\"row__label\"><div id=\"resultsTitle\" class=\"label\">Query has no results</div></section><section ng-show=\"results_Size\" class=\"row__label\"><div id=\"resultsTitle\" class=\"label\">Query has \{\{results_Size}} articles , Page #\{\{current_Page}} (\{\{current_Page_Split}} articles per page)</div><ul class=\"display-inline text-right\"><li><a id=\"view_Filters\" href=\"#\" title=\"View Filters\" ng-click=\"toggle_Filters()\" class=\"button btn-result icon-Filter\"></a></li></ul></section></div>");
