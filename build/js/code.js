...
(function() {
  ...
  app.run(function($templateCache) {
    ...
    $templateCache.put('/angular/jade-html/component/navigation/left_navigation', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><aside ng-controller=\"User_Navigation_Controller\"><ul><li><span class=\"logo\"></span></li><li ng-show=\"show_Loading_Image\"><icon class=\"Loading rotating\"></icon></li><li><!--a(ui-sref=\"queries\")--><a href=\"index\" ng-click=\"open_Query_State()\"><icon class=\"Home\"></icon></a></li><li><a ui-sref=\"main\"><icon class=\"User\"></icon></a></li><li><a ui-sref=\"docs\"><icon class=\"Info\"></icon></a></li><li><a href=\"/angular/guest/logout\"><icon class=\"Logout\"></icon></a><!--a(ui-sref=\"logout\")--></li></ul></aside>");
    ...
    $templateCache.put('/angular/jade-html/component/user/found_issue', "<div class=\"found-issue alert-ok\"><span class=\"alert-text\">Found an issue?  <a href=\"#\">Contact  </a>our team.</span></div>");
    ...
    $templateCache.put('/angular/jade-html/views/user/article', "<!--include ../mixins/globals--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><div class=\"main\"><article></article></div>");
    ...
    $templateCache.put('/angular/jade-html/views/user/index', "<div ng-controller=\"Index_Controller\" class=\"main\"><loading_bar></loading_bar><div class=\"\{\{column_Left}} application-scroll left-col\"><queries></queries></div><div class=\"\{\{column_Middle}} middle-col\"><breadcrumbs></breadcrumbs><results></results><filters_active></filters_active><div class=\"scrolling-results\"><articles></articles><pagination></pagination></div></div><div class=\"\{\{column_Right}} application-scroll right-col\"><div class=\"found-issue alert-ok\"><span class=\"alert-text\">Found an issue?  <a href=\"#\">Contact  </a>our team.</span></div><filters class=\"filters\"></filters></div></div>");
