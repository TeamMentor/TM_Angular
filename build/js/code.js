...
(function() {
  ...
  app.run(function($templateCache) {
    ...
    $templateCache.put('/angular/jade-html/component/user/pagination', "<span ng-controller=\"Pagination_Controller\"><!--adding .main so that it looks ok as a stand alone--><div class=\"main\"><div class=\"section row pagination\"><div class=\"previous\"><a href=\"#\" ng-click=\"previous_Page()\"><span class=\"icon-Arrow-Left\"></span><span> previous</span></a></div><div id=\"current_Page\" class=\"number\"><select ng-model=\"model.page\" ng-change=\"set_Page()\" ng-options=\"page for page in model.pages\"></select></div><div id=\"page_Splits\" class=\"number\"><select ng-model=\"model.page_Split\" ng-change=\"set_Page_Split()\" ng-options=\"page_Split for page_Split in model.page_Splits\"></select></div><div class=\"next\"><a href=\"#\" ng-click=\"next_Page()\"><span>next </span><span class=\"icon-Arrow-Right\"></span></a></div></div></div></span>");
    ...
    $templateCache.put('/angular/jade-html/views/user/index', "<!--.application--><div ng-controller=\"Index_Controller\"><div class=\"main\"><div class=\"section row\"><div class=\"\{\{column_Left}}\"><queries></queries></div><div class=\"\{\{column_Middle}}\"><results></results><pagination></pagination><breadcrumbs></breadcrumbs><filters_active></filters_active><articles></articles><pagination></pagination></div><div class=\"\{\{column_Right}}\"><filters></filters></div></div></div></div>");
...
(function() {
  ...
  Query_Service = (function() {
    ...
    Query_Service.prototype.load_Query_Articles = function(query_Id, from, to) {
      return this.TM_API.query_tree_articles(query_Id, from, to, (function(_this) {
        return function(data) {
