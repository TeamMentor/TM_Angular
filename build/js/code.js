...
(function() {
  ...
  app.run(function($templateCache) {
    ...
    $templateCache.put('/angular/jade-html/component/user/filters', "<!-- Application Icons--><!--mixin back-iconspan.icon-Arrow-Left --><!--mixin filter-icon--><!--  span.icon-Filter--><!--mixin forward-iconspan.icon-Arrow-Right --><!-- Filter Icons--><!-- filter icons--><div ng-controller=\"Filters_Controller\"><section ng-show=\"view_Filters\" class=\"row\"><dl><div id=\"filters\" ng-repeat=\"filter in filters\"><dt><div class=\"label no-underline\"><icon class=\"Filter\"></icon><span class=\"text\"> \{\{filter.title}}</span></div><span class=\"sub-nav__icon\"><a><span class=\"icon-Close\"></span></a></span></dt><div id=\"results\"><a ng-repeat=\"result in filter.results\"><dd href=\"#\" ng-click=\"apply_Filter(result.id, result.title)\" ng-show=\"result.size &gt;0\"><span><span id=\"filter-icon\" ng-bind-html=\"result.icon\"></span><span class=\"text\">\{\{result.title}}</span></span><span class=\"badge\">\{\{result.size}}</span></dd></a></div></div></dl></section></div>");
    ...
    $templateCache.put('/angular/jade-html/component/user/results', "<div ng-controller=\"Results_Controller\"><div class=\"desktop\"><div id=\"results\"><table><tr><!--if no_Resultstd p.label#no_results No Results p Please try again--><td><p id=\"resultsTitle\" class=\"label\">Query has \{\{results_Size}} articles</p></td><td><section class=\"row pagination\"><div class=\"previous\"><span class=\"icon-Arrow-Left\"></span></div><div class=\"number\"><select><option value=\"1\">1</option><option value=\"2\">2</option><option value=\"3\">3</option></select></div><div class=\"next\"><span class=\"icon-Arrow-Right\"></span></div></section></td><td><div id=\"filters\"><table><tr><td ng-repeat=\"(key,value) in current_Filters\" class=\"text-right\"><span id=\"activeFilter\" class=\"filter\"> \{\{value}}</span><span class=\"close\"><a href=\"#\" ng-click=\"clear_Filter(key)\">x</a></span></td></tr></table></div></td><td><ul class=\"display-inline\"><li><a id=\"view_Filters\" href=\"#\" title=\"View Filters\" ng-click=\"toggle_Filters()\" class=\"button btn-result icon-Filter\"></a></li><!--li--><!--  button.btn-result.icon-Save(title='Save results to Collection')--><!--libutton.btn-result.icon-Share(title='Share results')--></ul></td></tr></table></div></div></div>");
    ...
    $templateCache.put('/angular/jade-html/component/user_panel', "<!-- Application Icons--><!--mixin back-iconspan.icon-Arrow-Left --><!--mixin filter-icon--><!--  span.icon-Filter--><!--mixin forward-iconspan.icon-Arrow-Right --><!-- Filter Icons--><!-- filter icons--><section class=\"row__label\"><div class=\"label\">@username</div></section><section class=\"row\"><form><input type=\"text\" name=\"name\" value=\"First name, Last name\"/><input type=\"text\" name=\"work\" value=\"Position, Company\"/><input type=\"email\" name=\"email\" value=\"Email\"/><button type=\"submit\"><span class=\"icon-Tick\"></span></button></form></section>");
    $templateCache.put('/angular/jade-html/views/alert_application', "<!--extends ../_to_be_wired_in/_layouts/page_logged_in--><!-- Application Icons--><!--mixin back-iconspan.icon-Arrow-Left --><!--mixin filter-icon--><!--  span.icon-Filter--><!--mixin forward-iconspan.icon-Arrow-Right --><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-button--><!--    button.btn-result.icon-Save(title='Save results to Collection')--><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"application\"><main><div class=\"alert alert-ok\"><span class=\"alert-icon\">!</span><span class=\"alert-text\">Hi</span></div></main></div>");
    $templateCache.put('/angular/jade-html/views/article', "<!-- Application Icons--><!--mixin back-iconspan.icon-Arrow-Left --><!--mixin filter-icon--><!--  span.icon-Filter--><!--mixin forward-iconspan.icon-Arrow-Right --><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-button--><!--    button.btn-result.icon-Save(title='Save results to Collection')--><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><main><!-- Application Icons--><!--mixin back-iconspan.icon-Arrow-Left --><!--mixin filter-icon--><!--  span.icon-Filter--><!--mixin forward-iconspan.icon-Arrow-Right --><!-- Filter Icons--><!-- filter icons--><!-- Application Icons--><!--mixin back-iconspan.icon-Arrow-Left --><!--mixin filter-icon--><!--  span.icon-Filter--><!--mixin forward-iconspan.icon-Arrow-Right --><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-button--><!--    button.btn-result.icon-Save(title='Save results to Collection')--><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"col-9\"><div class=\"article\"><h1>\{\{article.title}}</h1><div id=\"html\" ng-bind-html=\"article_Html\" class=\"article-content\"></div></div><br/><footer><a href=\"http://www.securityinnovation.com/\" target=\"_blank\"><div class=\"si-logo\"></div></a><div class=\"icons\"><ul><li><div class=\"label no-underline\">TEAM Mentor 4.0</div></li><li><a href=\"mailto:support@securityinnovation.com\" title=\"Email\"><span title=\"Mail\" class=\"icon-Mail\"></span></a></li><li><a href=\"http://www.twitter.com/SecInnovation\" target=\"_blank\" title=\"Twitter\"><span title=\"Twitter\" class=\"icon-Twitter\"></span></a></li><li><a id=\"terms-and-conditions\" href=\"../misc/terms-and-conditions\" title=\"Terms and Conditions\"><span title=\"Terms &amp; Conditions\" class=\"icon-Paperclip\"></span></a></li></ul></div></footer></div><div class=\"col-3\"><section class=\"article-info\"><section class=\"row__label\"><div class=\"label\">Metadata:</div></section><section class=\"row\"><ul class=\"display-inline\"><li><div id=\"icon-technology\" ng-bind-html=\"icon_Technology\"></div></li><li><div id=\"icon-Type\" ng-bind-html=\"icon_Type\"></div></li><li><div id=\"icon-Phase\" ng-bind-html=\"icon_Phase\"></div></li></ul></section></section></div></main>");
    $templateCache.put('/angular/jade-html/views/article_editor', "<!DOCTYPE html><html lang=\"en\"><!-- Application Icons--><span id=\"filter-icon\"></span><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-button--><!--    button.btn-result.icon-Save(title='Save results to Collection')--><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><html lang=\"en-US\"></html><head><title>TEAM Mentor 4.0</title><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><meta name=\"description\" content=\"\"><meta name=\"author\" content=\"\"><link rel=\"icon\" href=\"/assets/favicons/favicon.ico\"><link href=\"/css/flare-stylesheet.css\" rel=\"stylesheet\"></head><body><div ng-controller=\"Search_Bar_Controller\" class=\"search\"><form ng-submit=\"submit()\"><ul><li><div class=\"logo\"></div></li></ul><select ng-model=\"selected_Technology\" ng-change=\"select_Technology(selected_Technology)\" ng-options=\"technology as technology.title for technology in technologies\"></select><input id=\"search-text\" type=\"text\" ng-model=\"text\" placeholder=\"Search TEAM Mentor\" class=\"search-input\"><button id=\"search-button\" type=\"submit\" class=\"btn-search\"><icon class=\"Search\"></icon></button></form></div><div class=\"application\"><main><div class=\"col-9\"><section class=\"article-body\"><section class=\"row\"><form class=\"article-editor\"><input type=\"text\" name=\"article-title\" placeholder=\"Article Title\"><textarea name=\"article-body\" placeholder=\"Article Body\"></textarea><section class=\"import-files\"><p>You can<a href=\"#\"> import</a> PDFs, images or Word documents.</p></section></form></section><section class=\"row__label\"><div class=\"label\">Directories</div><!-- This toggles the different editor functionalities for heirarchical structure.--><ul class=\"toggle-bar display-inline\"><form class=\"article-editor text-center\"><li class=\"one-third\"><input type=\"radio\" name=\"editor\" value=\"add\" id=\"add\"><label for=\"add\" class=\"button btn-result icon-Add\"></label></li><li class=\"one-third\"><input type=\"radio\" name=\"editor\" value=\"edit\" id=\"edit\"><label for=\"edit\" class=\"button btn-result icon-Edit\"></label></li><li class=\"one-third\"><input type=\"radio\" name=\"editor\" value=\"delete\" id=\"delete\"><label for=\"delete\" class=\"button btn-result icon-Delete\"></label></li></form></ul></section><section class=\"row\"><ul class=\"display-inline\"><!-- This is for display before any action is taken--><li class=\"one-third\"><dl><dt><div class=\"label\">Container</div></dt></dl></li><!-- This should be used for when the user toggles the Add or Edit functionality--><li class=\"one-third\"><dl><dt><div class=\"label\">Container</div><span class=\"sub-nav__icon\"><span class=\"icon-Arrow-Left\"></span></span></dt><dd><a href=\"#\" class=\"active\">Directory</a></dd><dd><a href=\"#\">Directory</a></dd><dd><a href=\"#\">Directory</a></dd></dl></li><!-- This should be used if the user wants to delete a container--><li class=\"one-third\"><dl><dt><div class=\"label\">Container</div></dt><dd><form><label for=\"delete-directory\">Are you sure you want to delete this?</label><ul class=\"display-inline\"><li><button type=\"submit\" class=\"btn-editor\"><span class=\"icon-Tick\"></span></button></li><li><button type=\"cancel\" class=\"btn-editor cancel\"><span class=\"icon-Close\"></span></button></li></ul></form></dd></dl></li></ul></section><section class=\"row__label\"><div class=\"label\">Filters</div></section><section class=\"row\"><br><form class=\"article-editor-grid\"><div><input type=\"checkbox\" id=\"filter1\"><label for=\"filter1\"><span title=\"Technology Independent\" class=\"icon-All\"><span class=\"path1\"></span><span class=\"path2\"></span></span><span>Technology Independant</span></label></div><div><input type=\"checkbox\" id=\"filter2\"><label for=\"filter2\"><span title=\"Android\" class=\"icon-Android\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span><span class=\"path4\"></span><span class=\"path5\"></span></span><span>Android</span></label></div><div><input type=\"checkbox\" id=\"filter3\"><label for=\"filter3\"><span title=\"Scala\" class=\"icon-Scala\"><span class=\"path1\"></span><span class=\"path2\"></span></span><span>Scala</span></label></div><div><input type=\"checkbox\" id=\"filter4\"><label for=\"filter4\"><span title=\"WCF\" class=\"icon-WCF\"><span class=\"path1\"></span><span class=\"path2\"></span></span><span>WCF</span></label></div><div><input type=\"checkbox\" id=\"filter5\"><label for=\"filter5\"><span title=\"Web Application\" class=\"icon-Web-App\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span><span class=\"path4\"></span><span class=\"path5\"></span><span class=\"path6\"></span><span class=\"path7\"></span><span class=\"path8\"></span><span class=\"path9\"></span><span class=\"path10\"></span><span class=\"path11\"></span></span><span>Web Application</span></label></div><div><input type=\"checkbox\" id=\"filter6\"><label for=\"filter6\"><span title=\"iOS\" class=\"icon-iOS\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>iOS</span></label></div><div><input type=\"checkbox\" id=\"filter7\"><label for=\"filter7\"><span title=\"HTML5\" class=\"icon-HTML5\"><span class=\"path1\"></span><span class=\"path2\"></span></span><span class=\"text\">HTML5</span></label></div></form></section><section class=\"row__label\"><div class=\"label\">Quality</div></section><section class=\"row\"><p>Quality slider, needs to be built with Angular so I can style</p></section></section></div><div class=\"col-3\"><section class=\"article-info\"><ul class=\"display-inline\"><li><button type=\"submit\" class=\"btn-editor\"><span class=\"icon-Tick\"></span></button></li><li><button type=\"submit\" class=\"btn-editor cancel\"><span class=\"icon-Close\"></span></button></li></ul></section></div></main></div></body></html>");
    $templateCache.put('/angular/jade-html/views/article_view_editor_option', "<!DOCTYPE html><html lang=\"en\"><!-- Application Icons--><span id=\"filter-icon\"></span><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-button--><!--    button.btn-result.icon-Save(title='Save results to Collection')--><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><html lang=\"en-US\"></html><head><title>TEAM Mentor 4.0</title><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><meta name=\"description\" content=\"\"><meta name=\"author\" content=\"\"><link rel=\"icon\" href=\"/assets/favicons/favicon.ico\"><link href=\"/css/flare-stylesheet.css\" rel=\"stylesheet\"></head><body><div ng-controller=\"Search_Bar_Controller\" class=\"search\"><form ng-submit=\"submit()\"><ul><li><div class=\"logo\"></div></li></ul><select ng-model=\"selected_Technology\" ng-change=\"select_Technology(selected_Technology)\" ng-options=\"technology as technology.title for technology in technologies\"></select><input id=\"search-text\" type=\"text\" ng-model=\"text\" placeholder=\"Search TEAM Mentor\" class=\"search-input\"><button id=\"search-button\" type=\"submit\" class=\"btn-search\"><icon class=\"Search\"></icon></button></form></div><div class=\"application\"><main><div class=\"col-9\"><section class=\"article-body\"><section class=\"row__article\"><h1>Article Title</h1></section></section></div><div class=\"col-3\"><section class=\"article-info\"><ul class=\"display-inline\"><li><button type=\"submit\" id=\"btn-edit\" class=\"btn-result icon-Edit\"></button></li><li><button title=\"Save article to Collection\" class=\"btn-result icon-Save\"></button></li><li><button title=\"Share all articles\" class=\"btn-result icon-Share\"></button></li></ul><section class=\"row__label\"><div class=\"label\">Relates to:</div></section><section class=\"row\"><ul class=\"display-inline\"><li><!--+show-icon('Technology', technology)--><span class=\"text\"></span></li><li><!--+show-icon('Phase', phase)--></li><li><!--+show-icon('Type', type)--></li></ul></section><section class=\"row__label\"><div class=\"label\">Belongs to:</div></section><section class=\"row\"><ul><li><a href=\"/flare/curated-content\"><span class=\"icon-Curated-Content\"></span><span class=\"text\">Curated Content</span></a></li></ul></section><section class=\"row__label\"><div class=\"label\">Related Articles:</div></section><section class=\"row\"><ul><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li></ul></section></section></div></main></div></body></html>");
    ...
    $templateCache.put('/angular/jade-html/views/curated_content', "<!--extends ../_to_be_wired_in/_layouts/page_logged_in--><!-- Application Icons--><span id=\"filter-icon\"></span><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-button--><!--    button.btn-result.icon-Save(title='Save results to Collection')--><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"application\"><main><section class=\"row\"><div class=\"col-3\"><dl><dt><div class=\"label\">Curated Content</div><span class=\"sub-nav__icon\"><span class=\"icon-Arrow-Left\"></span></span></dt><dd><a href=\"#\">Item One</a></dd><dd><a href=\"#\">Item Two</a></dd><dd><a href=\"#\">Item Three</a></dd></dl></div><div class=\"col-9\"><section class=\"row\"><span id=\"result_article\"></span></section></div></section></main></div>");
    $templateCache.put('/angular/jade-html/views/curated_content_article', "<!DOCTYPE html><html lang=\"en\"><!-- Application Icons--><span id=\"filter-icon\"></span><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-button--><!--    button.btn-result.icon-Save(title='Save results to Collection')--><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><html lang=\"en-US\"></html><head><title>TEAM Mentor 4.0</title><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><meta name=\"description\" content=\"\"><meta name=\"author\" content=\"\"><link rel=\"icon\" href=\"/assets/favicons/favicon.ico\"><link href=\"/css/flare-stylesheet.css\" rel=\"stylesheet\"></head><body><div ng-controller=\"Search_Bar_Controller\" class=\"search\"><form ng-submit=\"submit()\"><ul><li><div class=\"logo\"></div></li></ul><select ng-model=\"selected_Technology\" ng-change=\"select_Technology(selected_Technology)\" ng-options=\"technology as technology.title for technology in technologies\"></select><input id=\"search-text\" type=\"text\" ng-model=\"text\" placeholder=\"Search TEAM Mentor\" class=\"search-input\"><button id=\"search-button\" type=\"submit\" class=\"btn-search\"><icon class=\"Search\"></icon></button></form></div><div class=\"application\"><main><div class=\"col-9\"><section class=\"article-body\"><section class=\"row__article\"><h1>Article Title</h1></section></section></div><div class=\"col-3\"><section class=\"article-info\"><ul class=\"display-inline\"><li><button type=\"submit\" id=\"btn-edit\" class=\"btn-result icon-Edit\"></button></li><li><button title=\"Save article to Collection\" class=\"btn-result icon-Save\"></button></li><li><button title=\"Share all articles\" class=\"btn-result icon-Share\"></button></li></ul><section class=\"row__label\"><div class=\"label\">Relates to:</div></section><section class=\"row\"><ul class=\"display-inline\"><li><!--+show-icon('Technology', technology)--><span class=\"text\"></span></li><li><!--+show-icon('Phase', phase)--></li><li><!--+show-icon('Type', type)--></li></ul></section><section class=\"row__label\"><div class=\"label\">Belongs to:</div></section><section class=\"row\"><ul><li><a href=\"/flare/curated-content\"><span class=\"icon-Curated-Content\"></span><span class=\"text\">Curated Content</span></a></li></ul></section><section class=\"row__label\"><div class=\"label\">Related Articles:</div></section><section class=\"row\"><ul><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li></ul></section></section></div></main></div></body></html>");
