...
(function() {
  ...
  app.run(function($templateCache) {
    ...
    $templateCache.put('/angular/jade-html/component/user/articles', "<!-- Application Icons--><!--mixin filter-icon--><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><div ng-controller=\"Articles_Controller\"><section class=\"row\"><article-box ng-repeat=\"article in articles\"></article-box></section></div>");
    ...
    $templateCache.put('/angular/jade-html/component/user/filters', "<!-- Application Icons--><!--mixin filter-icon--><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><div ng-controller=\"Filters_Controller\"><section class=\"row\"><dl><div id=\"filters\" ng-repeat=\"filter in filters\"><dt><div class=\"label no-underline\"><icon class=\"Filter\"></icon><span class=\"text\"> \{\{filter.title}}</span></div><!--span.sub-nav__icona +close-icon--></dt><a ng-repeat=\"result in filter.results\"><dd ng-href=\"#\" ng-click=\"apply_Filter(result.id, result.title)\" ng-show=\"result.size &gt;0\"><span><span id=\"filter-icon\" ng-bind-html=\"result.icon\"></span><span class=\"text\">\{\{result.title}}</span></span><span class=\"badge\">\{\{result.size}}</span></dd></a></div></dl></section></div>");
    ...
    $templateCache.put('/angular/jade-html/views/curated_content', "<!--extends ../_to_be_wired_in/_layouts/page_logged_in--><!-- Application Icons--><!--mixin filter-icon--><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><!-- Getting Started--><!-- User Inputs--><div class=\"application\"><main><section class=\"row\"><div class=\"col-3\"><dl><dt><div class=\"label\">Curated Content</div><span class=\"sub-nav__icon\"><span class=\"icon-Arrow-Left\"></span></span></dt><dd><a href=\"#\">Item One</a></dd><dd><a href=\"#\">Item Two</a></dd><dd><a href=\"#\">Item Three</a></dd></dl></div><div class=\"col-9\"><section class=\"row\"><span id=\"result_article\"></span></section></div></section></main></div>");
    $templateCache.put('/angular/jade-html/views/curated_content_article', "<!DOCTYPE html><html lang=\"en\"><!-- Application Icons--><!--mixin filter-icon--><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><!-- Getting Started--><!-- User Inputs--><html lang=\"en-US\"></html><head><title>TEAM Mentor 4.0</title><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><meta name=\"description\" content=\"\"><meta name=\"author\" content=\"\"><link rel=\"icon\" href=\"/assets/favicons/favicon.ico\"><link href=\"/css/flare-stylesheet.css\" rel=\"stylesheet\"></head><body><!-- Application Icons--><!--mixin filter-icon--><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><div ng-controller=\"Search_Controller\" class=\"search\"><form ng-submit=\"submit()\"><ul><li><div class=\"application-logo\"></div></li></ul><select><option ng-repeat=\"technology in technologies\" value=\"\{\{technology}}\">\{\{technology}}</option></select><input id=\"search-text\" type=\"text\" ng-model=\"text\" placeholder=\"Type keywords here\" class=\"search-input\"><button id=\"search-button\" type=\"submit\" class=\"btn-search\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span></button></form></div><div class=\"application\"><main><div class=\"col-9\"><section class=\"article-body\"><section class=\"row__article\"><h1>Article Title</h1></section></section></div><div class=\"col-3\"><section class=\"article-info\"><ul class=\"display-inline\"><li><button type=\"submit\" id=\"btn-edit\" class=\"btn-result icon-Edit\"></button></li><li><button title=\"Save article to Collection\" class=\"btn-result icon-Save\"></button></li><li><button title=\"Share all articles\" class=\"btn-result icon-Share\"></button></li></ul><section class=\"row__label\"><div class=\"label\">Relates to:</div></section><section class=\"row\"><ul class=\"display-inline\"><li><!--+show-icon('Technology', technology)--><span class=\"text\"></span></li><li><!--+show-icon('Phase', phase)--></li><li><!--+show-icon('Type', type)--></li></ul></section><section class=\"row__label\"><div class=\"label\">Belongs to:</div></section><section class=\"row\"><ul><li><a href=\"/flare/curated-content\"><span class=\"icon-Curated-Content\"></span><span class=\"text\">Curated Content</span></a></li></ul></section><section class=\"row__label\"><div class=\"label\">Related Articles:</div></section><section class=\"row\"><ul><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li></ul></section></section></div></main></div></body></html>");
    $templateCache.put('/angular/jade-html/views/docs', "<main ng-controller=\"Help_Controller\" class=\"help\"><section class=\"row\"><div class=\"col-3\"><help-navigation></help-navigation></div><div class=\"col-9\"><!--article--><div id=\"help\" class=\"article\"><h1 id=\"help-title\">\{\{title}}</h1><help-content ng-bind-html=\"content\"></help-content></div></div></section></main>");
...
(function() {
  angular.module('TM_App').controller('Results_Controller', function($scope) {
    return $scope.history = {};
  });
