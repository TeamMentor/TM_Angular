...
(function() {
  ...
  app.run(function($templateCache) {
    ...
    $templateCache.put('/angular/jade-html/component/navigate_results', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons-->");
    ...
    $templateCache.put('/angular/jade-html/component/result_search_term', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"article search-term\"><a href=\"app-keyword-search\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>Search Term</span></a></div>");
    ...
    $templateCache.put('/angular/jade-html/views/alert_application', "<!--extends ../_to_be_wired_in/_layouts/page_logged_in--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"application\"><div class=\"main\"><div class=\"alert alert-ok\"><span class=\"alert-icon\">!</span><span class=\"alert-text\">Hi</span></div></div></div>");
    $templateCache.put('/angular/jade-html/views/article', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"main\"><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"col-9\"><div class=\"article\"><h1>\{\{article.title}}</h1><div id=\"html\" ng-bind-html=\"article_Html\" class=\"article-content\"></div></div><br/><div class=\"footer\"><a href=\"http://www.securityinnovation.com/\" target=\"_blank\"><div class=\"si-logo\"></div></a><div class=\"icons\"><ul><li><div class=\"label no-underline\">TEAM Mentor 4.0</div></li><li><a href=\"mailto:support@securityinnovation.com\" title=\"Email\"><span title=\"Mail\" class=\"icon-Mail\"></span></a></li><li><a href=\"http://www.twitter.com/SecInnovation\" target=\"_blank\" title=\"Twitter\"><span title=\"Twitter\" class=\"icon-Twitter\"></span></a></li><li><a id=\"terms-and-conditions\" ui-sref=\"terms_and_conditions\"><span title=\"Terms &amp; Conditions\" class=\"icon-Paperclip\"></span></a></li></ul></div></div></div><div class=\"col-3\"><div class=\"section article-info\"><div class=\"section row__label\"><div class=\"label\">Relates to:</div></div><div class=\"section row\"><ul class=\"display-inline\"><li><div id=\"icon-technology\" ng-bind-html=\"icon_Technology\"></div></li><li><div id=\"icon-Type\" ng-bind-html=\"icon_Type\"></div></li><li><div id=\"icon-Phase\" ng-bind-html=\"icon_Phase\"></div></li></ul></div></div></div></div>");
    $templateCache.put('/angular/jade-html/views/article_editor', "<!DOCTYPE html><html lang=\"en\"><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><html lang=\"en-US\"></html><head><title>TEAM Mentor 4.0</title><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><meta name=\"description\" content=\"\"><meta name=\"author\" content=\"\"><link rel=\"icon\" href=\"/assets/favicons/favicon.ico\"><link href=\"/css/flare-stylesheet.css\" rel=\"stylesheet\"></head><body><div ng-controller=\"Search_Bar_Controller\" class=\"search\"><form ng-submit=\"submit()\"><ul><li><div class=\"logo\"></div></li></ul><select ng-model=\"selected_Technology\" ng-change=\"select_Technology(selected_Technology)\" ng-options=\"technology as technology.title for technology in technologies\"></select><input id=\"search-text\" type=\"text\" ng-model=\"text\" placeholder=\"Search TEAM Mentor\" class=\"search-input\"><button id=\"search-button\" type=\"submit\" class=\"btn-search\"><icon class=\"Search\"></icon></button></form></div><div class=\"application\"><div class=\"main\"><div class=\"col-9\"><div class=\"section article-body\"><div class=\"section row\"><form class=\"article-editor\"><input type=\"text\" name=\"article-title\" placeholder=\"Article Title\"/><textarea name=\"article-body\" placeholder=\"Article Body\"></textarea><div class=\"section import-files\"><p>You can<a href=\"#\"> import</a> PDFs, images or Word documents.</p></div></form></div><div class=\"section row__label\"><div class=\"label\">Directories</div><!-- This toggles the different editor functionalities for heirarchical structure.--><ul class=\"toggle-bar display-inline\"><form class=\"article-editor text-center\"><li class=\"one-third\"><input type=\"radio\" name=\"editor\" value=\"add\" id=\"add\"/><label for=\"add\" class=\"button btn-result icon-Add\"></label></li><li class=\"one-third\"><input type=\"radio\" name=\"editor\" value=\"edit\" id=\"edit\"/><label for=\"edit\" class=\"button btn-result icon-Edit\"></label></li><li class=\"one-third\"><input type=\"radio\" name=\"editor\" value=\"delete\" id=\"delete\"/><label for=\"delete\" class=\"button btn-result icon-Delete\"></label></li></form></ul></div><div class=\"section row\"><ul class=\"display-inline\"><!-- This is for display before any action is taken--><li class=\"one-third\"><dl><dt><div class=\"label\">Container</div></dt></dl></li><!-- This should be used for when the user toggles the Add or Edit functionality--><li class=\"one-third\"><dl><dt><div class=\"label\">Container</div><span class=\"sub-nav__icon\"><span class=\"icon-Arrow-Left\"></span></span></dt><dd><a href=\"#\" class=\"active\">Directory</a></dd><dd><a href=\"#\">Directory</a></dd><dd><a href=\"#\">Directory</a></dd></dl></li><!-- This should be used if the user wants to delete a container--><li class=\"one-third\"><dl><dt><div class=\"label\">Container</div></dt><dd><form><label for=\"delete-directory\">Are you sure you want to delete this?</label><ul class=\"display-inline\"><li><button type=\"submit\" class=\"btn-editor\"><span class=\"icon-Tick\"></span></button></li><li><button type=\"cancel\" class=\"btn-editor cancel\"><span class=\"icon-Close\"></span></button></li></ul></form></dd></dl></li></ul></div><div class=\"section row__label\"><div class=\"label\">Filters</div></div><div class=\"section row\"><br/><form class=\"article-editor-grid\"><div><input type=\"checkbox\" id=\"filter1\"/><label for=\"filter1\"><span title=\"Technology Independent\" class=\"icon-All\"><span class=\"path1\"></span><span class=\"path2\"></span></span><span>Technology Independant</span></label></div><div><input type=\"checkbox\" id=\"filter2\"/><label for=\"filter2\"><span title=\"Android\" class=\"icon-Android\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span><span class=\"path4\"></span><span class=\"path5\"></span></span><span>Android</span></label></div><div><input type=\"checkbox\" id=\"filter3\"/><label for=\"filter3\"><span title=\"Scala\" class=\"icon-Scala\"><span class=\"path1\"></span><span class=\"path2\"></span></span><span>Scala</span></label></div><div><input type=\"checkbox\" id=\"filter4\"/><label for=\"filter4\"><span title=\"WCF\" class=\"icon-WCF\"><span class=\"path1\"></span><span class=\"path2\"></span></span><span>WCF</span></label></div><div><input type=\"checkbox\" id=\"filter5\"/><label for=\"filter5\"><span title=\"Web Application\" class=\"icon-Web-App\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span><span class=\"path4\"></span><span class=\"path5\"></span><span class=\"path6\"></span><span class=\"path7\"></span><span class=\"path8\"></span><span class=\"path9\"></span><span class=\"path10\"></span><span class=\"path11\"></span></span><span>Web Application</span></label></div><div><input type=\"checkbox\" id=\"filter6\"/><label for=\"filter6\"><span title=\"iOS\" class=\"icon-iOS\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>iOS</span></label></div><div><input type=\"checkbox\" id=\"filter7\"/><label for=\"filter7\"><span title=\"HTML5\" class=\"icon-HTML5\"><span class=\"path1\"></span><span class=\"path2\"></span></span><span class=\"text\">HTML5</span></label></div></form></div><div class=\"section row__label\"><div class=\"label\">Quality</div></div><div class=\"section row\"><p>Quality slider, needs to be built with Angular so I can style</p></div></div></div><div class=\"col-3\"><div class=\"section article-info\"><ul class=\"display-inline\"><li><button type=\"submit\" class=\"btn-editor\"><span class=\"icon-Tick\"></span></button></li><li><button type=\"submit\" class=\"btn-editor cancel\"><span class=\"icon-Close\"></span></button></li></ul></div></div></div></div></body></html>");
    $templateCache.put('/angular/jade-html/views/article_view_editor_option', "<!DOCTYPE html><html lang=\"en\"><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><html lang=\"en-US\"></html><head><title>TEAM Mentor 4.0</title><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><meta name=\"description\" content=\"\"><meta name=\"author\" content=\"\"><link rel=\"icon\" href=\"/assets/favicons/favicon.ico\"><link href=\"/css/flare-stylesheet.css\" rel=\"stylesheet\"></head><body><div ng-controller=\"Search_Bar_Controller\" class=\"search\"><form ng-submit=\"submit()\"><ul><li><div class=\"logo\"></div></li></ul><select ng-model=\"selected_Technology\" ng-change=\"select_Technology(selected_Technology)\" ng-options=\"technology as technology.title for technology in technologies\"></select><input id=\"search-text\" type=\"text\" ng-model=\"text\" placeholder=\"Search TEAM Mentor\" class=\"search-input\"><button id=\"search-button\" type=\"submit\" class=\"btn-search\"><icon class=\"Search\"></icon></button></form></div><div class=\"application\"><div class=\"main\"><div class=\"col-9\"><div class=\"section row article\"><div class=\"col-10\"><h1>Article Title</h1></div><div class=\"col-2\"><ul class=\"display-inline\"><li class=\"full-width\"><a href=\"#\" class=\"button btn-minor full-width\"><span class=\"icon-Arrow-Left\"></span><span class=\"text\">Back</span></a></li></ul></div></div></div><div class=\"col-3\"><div class=\"section article-info\"><ul class=\"display-inline\"><li><button type=\"submit\" id=\"btn-edit\" class=\"btn-result icon-Edit\"></button></li><li><button title=\"Save article to Collection\" class=\"btn-result icon-Save\"></button></li><li><button title=\"Share all articles\" class=\"btn-result icon-Share\"></button></li></ul><div class=\"section row__label\"><div class=\"label\">Relates to:</div></div><div class=\"section row\"><ul class=\"display-inline\"><li><!--+show-icon('Technology', technology)--><span class=\"text\"></span></li><li><!--+show-icon('Phase', phase)--></li><li><!--+show-icon('Type', type)--></li></ul></div><div class=\"section row__label\"><div class=\"label\">Belongs to:</div></div><div class=\"section row\"><ul><li><a href=\"/flare/curated-content\"><span class=\"icon-Curated-Content\"></span><span class=\"text\">Curated Content</span></a></li></ul></div><div class=\"section row__label\"><div class=\"label\">Related Articles:</div></div><div class=\"section row\"><ul><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li></ul></div></div></div></div></div></body></html>");
    $templateCache.put('/angular/jade-html/views/curated_content', "<!--extends ../_to_be_wired_in/_layouts/page_logged_in--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"application\"><div class=\"main\"><div class=\"section row\"><div class=\"col-3\"><dl><dt><div class=\"label\">Curated Content</div><span class=\"sub-nav__icon\"><span class=\"icon-Arrow-Left\"></span></span></dt><dd><a href=\"#\">Item One</a></dd><dd><a href=\"#\">Item Two</a></dd><dd><a href=\"#\">Item Three</a></dd></dl></div><div class=\"col-9\"><div class=\"section row\"><article-box></article-box><!--include ../component/result_article.jade--></div></div></div></div></div>");
    $templateCache.put('/angular/jade-html/views/curated_content_article', "<!DOCTYPE html><html lang=\"en\"><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><html lang=\"en-US\"></html><head><title>TEAM Mentor 4.0</title><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><meta name=\"description\" content=\"\"><meta name=\"author\" content=\"\"><link rel=\"icon\" href=\"/assets/favicons/favicon.ico\"><link href=\"/css/flare-stylesheet.css\" rel=\"stylesheet\"></head><body><div ng-controller=\"Search_Bar_Controller\" class=\"search\"><form ng-submit=\"submit()\"><ul><li><div class=\"logo\"></div></li></ul><select ng-model=\"selected_Technology\" ng-change=\"select_Technology(selected_Technology)\" ng-options=\"technology as technology.title for technology in technologies\"></select><input id=\"search-text\" type=\"text\" ng-model=\"text\" placeholder=\"Search TEAM Mentor\" class=\"search-input\"><button id=\"search-button\" type=\"submit\" class=\"btn-search\"><icon class=\"Search\"></icon></button></form></div><div class=\"application\"><div class=\"main\"><div class=\"col-9\"><div class=\"section row article\"><div class=\"col-10\"><h1>Article Title</h1></div><div class=\"col-2\"><ul class=\"display-inline\"><li class=\"full-width\"><a href=\"#\" class=\"button btn-minor full-width\"><span class=\"icon-Arrow-Left\"></span><span class=\"text\">Back</span></a></li></ul></div></div></div><div class=\"col-3\"><div class=\"section article-info\"><ul class=\"display-inline\"><li><button type=\"submit\" id=\"btn-edit\" class=\"btn-result icon-Edit\"></button></li><li><button title=\"Save article to Collection\" class=\"btn-result icon-Save\"></button></li><li><button title=\"Share all articles\" class=\"btn-result icon-Share\"></button></li></ul><div class=\"section row__label\"><div class=\"label\">Relates to:</div></div><div class=\"section row\"><ul class=\"display-inline\"><li><!--+show-icon('Technology', technology)--><span class=\"text\"></span></li><li><!--+show-icon('Phase', phase)--></li><li><!--+show-icon('Type', type)--></li></ul></div><div class=\"section row__label\"><div class=\"label\">Belongs to:</div></div><div class=\"section row\"><ul><li><a href=\"/flare/curated-content\"><span class=\"icon-Curated-Content\"></span><span class=\"text\">Curated Content</span></a></li></ul></div><div class=\"section row__label\"><div class=\"label\">Related Articles:</div></div><div class=\"section row\"><ul><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li></ul></div></div></div></div></div></body></html>");
    $templateCache.put('/angular/jade-html/views/docs', "<div ng-controller=\"Help_Controller\" class=\"main help\"><div class=\"section row\"><div class=\"col-3\"><help-navigation></help-navigation></div><div class=\"col-9\"><!--article--><div id=\"help\" class=\"article\"><h1 id=\"help-title\">\{\{title}}</h1><help-content ng-bind-html=\"content\"></help-content></div></div></div></div>");
    ...
    $templateCache.put('/angular/jade-html/views/guest/about', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"section row__landing-page\"><div class=\"section about\"><h3 id=\"an-interactive-application-security-library-with-thousands-of-code-samples-and-professional-guidance-when-you-need-it\">An interactive Application Security library with thousands of code samples and professional guidance when you need it</h3> </div><div class=\"section about-us\"><h4 id=\"team-mentor-was-created-by-developers-for-developers-using-secure-coding-standards-code-snippets-and-checklists-built-from-10-years-of-targeted-security-assessments-for-fortune-500-organizations-\">TEAM Mentor was created by developers for developers using secure coding standards, code snippets and checklists built from 10+ years of targeted security assessments for Fortune 500 organizations.</h4> <p>It contains thousands of articles with dynamic content across multiple development platforms including .NET, Java, C/C++, PHP, Android and iOS. TEAM Mentor is the In-Practice companion to our <a href=\"https://www.securityinnovation.com/training/application-security/computer-based/\">TEAM Professor eLearning courses</a>, extending developers’ knowledge in combination with training.</p> <p>TEAM Mentor integrates with static analysis tools, such as Checkmarx and Fortify&trade;, helping teams make more sense of scan results and make critical decisions to fix software vulnerabilities.</p> </div><div class=\"section call-to-action\"><h2 id=\"security-risk-understood-\">Security Risk. Understood.</h2> <a ui-sref=\"sign_up\" class=\"button\">See for yourself</a></div><div class=\"footer\"><a href=\"http://www.securityinnovation.com/\" target=\"_blank\"><div class=\"si-logo\"></div></a><div class=\"icons\"><ul><li><div class=\"label no-underline\">TEAM Mentor 4.0</div></li><li><a href=\"mailto:support@securityinnovation.com\" title=\"Email\"><span title=\"Mail\" class=\"icon-Mail\"></span></a></li><li><a href=\"http://www.twitter.com/SecInnovation\" target=\"_blank\" title=\"Twitter\"><span title=\"Twitter\" class=\"icon-Twitter\"></span></a></li><li><a id=\"terms-and-conditions\" ui-sref=\"terms_and_conditions\"><span title=\"Terms &amp; Conditions\" class=\"icon-Paperclip\"></span></a></li></ul></div></div></div>");
    $templateCache.put('/angular/jade-html/views/guest/features', "<!--extends ../_to_be_wired_in/_layouts/page_logged_out--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"section row__landing-page\"><div class=\"section features\"><h2 id=\"team-mentor-provides-intelligence-to-fix-vulnerabilities-and-comply\">TEAM Mentor provides intelligence to fix vulnerabilities and comply</h2> <div class=\"section row\"><div class=\"col-3 text-center\"><div class=\"delivers-compliance\"></div></div><div class=\"col-9\"><p>Delivers compliance-specific secure coding guidance for PCI-DSS, OWASP Top 10, CWE and other popular frameworks.</p> </div></div><div class=\"section row\"><div class=\"col-3 text-center\"><div class=\"integrates\"></div></div><div class=\"col-9\"><p>Integrates with multiple static analysis tools and developer environments (IDE’s) to map prescriptive coding guidance to scan results to fix vulnerabilities.</p> </div></div><div class=\"section row\"><div class=\"col-3 text-center\"><div class=\"cross-references\"></div></div><div class=\"col-9\"><p>Stores and cross-references your security policies with out-of-the-box secure coding checklists and examples.</p> </div></div><div class=\"section row\"><div class=\"col-3 text-center\"><div class=\"provides-guidance\"></div></div><div class=\"col-9\"><p>Provides guidance to assist developers in reducing security vulnerabilities in software applications.</p> </div></div></div><div class=\"section call-to-action\"><h2 id=\"security-risk-understood-\">Security Risk. Understood.</h2> <a ui-sref=\"sign_up\" class=\"button\">See for yourself</a></div><div class=\"footer\"><a href=\"http://www.securityinnovation.com/\" target=\"_blank\"><div class=\"si-logo\"></div></a><div class=\"icons\"><ul><li><div class=\"label no-underline\">TEAM Mentor 4.0</div></li><li><a href=\"mailto:support@securityinnovation.com\" title=\"Email\"><span title=\"Mail\" class=\"icon-Mail\"></span></a></li><li><a href=\"http://www.twitter.com/SecInnovation\" target=\"_blank\" title=\"Twitter\"><span title=\"Twitter\" class=\"icon-Twitter\"></span></a></li><li><a id=\"terms-and-conditions\" ui-sref=\"terms_and_conditions\"><span title=\"Terms &amp; Conditions\" class=\"icon-Paperclip\"></span></a></li></ul></div></div></div>");
    $templateCache.put('/angular/jade-html/views/guest/home', "<!--extends ../_to_be_wired_in/_layouts/page_logged_out--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"section row__landing-page\"><div class=\"section usp\"><h2 id=\"instant-resources-that-bridge-the-gap-between-developer-questions-and-technical-solutions\">Instant resources that bridge the gap between developer questions and technical solutions</h2> <a ui-sref=\"sign_up\" class=\"button\">Start your free trial today</a></div><div class=\"section row reasons\"><h2 id=\"with-team-mentor-you-can-\">With TEAM Mentor, you can...</h2> <div class=\"section row\"><div class=\"col-3 text-center\"><div class=\"fix-vulnerabilities\"></div></div><div class=\"col-9\"><p>Fix vulnerabilities quicker than ever before with TEAM Mentor&#39;s seamless integration into a developer&#39;s IDE and daily workflow.</p> </div></div><div class=\"section row\"><div class=\"col-3 text-center\"><div class=\"reduce-vulnerabilities\"></div></div><div class=\"col-9\"><p>Reduce the number of vulnerabilities over time as developers learn about each vulnerability at the time it is identified.</p> </div></div><div class=\"section row\"><div class=\"col-3 text-center\"><div class=\"improve-process\"></div></div><div class=\"col-9\"><p>Expand the development team&#39;s knowledge and improve processes with access to thousands of specific remediation tactics, including the host organization&#39;s security policies and coding best practices.</p> </div></div></div><div class=\"section clients\"><h3 id=\"our-clients-love-us-and-we-think-you-will-too-\">Our clients love us (and we think you will too!)</h3> <img src=\"/assets/clients/flare-logos.jpg\"/></div><div class=\"section call-to-action\"><h2 id=\"security-risk-understood-\">Security Risk. Understood.</h2> <a ui-sref=\"sign_up\" class=\"button\">See for yourself</a></div><div class=\"footer\"><a href=\"http://www.securityinnovation.com/\" target=\"_blank\"><div class=\"si-logo\"></div></a><div class=\"icons\"><ul><li><div class=\"label no-underline\">TEAM Mentor 4.0</div></li><li><a href=\"mailto:support@securityinnovation.com\" title=\"Email\"><span title=\"Mail\" class=\"icon-Mail\"></span></a></li><li><a href=\"http://www.twitter.com/SecInnovation\" target=\"_blank\" title=\"Twitter\"><span title=\"Twitter\" class=\"icon-Twitter\"></span></a></li><li><a id=\"terms-and-conditions\" ui-sref=\"terms_and_conditions\"><span title=\"Terms &amp; Conditions\" class=\"icon-Paperclip\"></span></a></li></ul></div></div></div>");
    $templateCache.put('/angular/jade-html/views/guest/login', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><!--mixin forgot-pwd-form.section.row__label .label Forgot your password? .section.row form#forgot-pwd-form(action='#') .section.row .col-8.input-field +email-input .col-4.button-field br +get-password-button --><div class=\"section row\"><div class=\"col-7\"><login-form></login-form></div><div class=\"col-1\"></div><div class=\"col-4\"><div class=\"section tm-summary\"><div class=\"section row__label\"><div class=\"label\">With TEAM Mentor, you can...</div></div><div class=\"section row\"><table><tr><td><div class=\"fix-vulnerabilities\"></div></td><td><p>Fix vulnerabilities quicker than ever before.</p> </td></tr><tr><td><div class=\"reduce-vulnerabilities\"></div></td><td><p>Reduce the number of vulnerabilities over time.</p> </td></tr><tr><td><div class=\"improve-process\"></div></td><td><p>Expand the development team&#39;s knowledge and improve process.</p> </td></tr></table></div></div></div></div>");
    $templateCache.put('/angular/jade-html/views/guest/sign_up', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><!--mixin forgot-pwd-form.section.row__label .label Forgot your password? .section.row form#forgot-pwd-form(action='#') .section.row .col-8.input-field +email-input .col-4.button-field br +get-password-button --><div class=\"section row\"><div class=\"col-7\"><sign-up-form></sign-up-form></div><div class=\"col-1\"></div><div class=\"col-4\"><div class=\"section tm-summary\"><div class=\"section row__label\"><div class=\"label\">With TEAM Mentor, you can...</div></div><div class=\"section row\"><table><tr><td><div class=\"fix-vulnerabilities\"></div></td><td><p>Fix vulnerabilities quicker than ever before.</p> </td></tr><tr><td><div class=\"reduce-vulnerabilities\"></div></td><td><p>Reduce the number of vulnerabilities over time.</p> </td></tr><tr><td><div class=\"improve-process\"></div></td><td><p>Expand the development team&#39;s knowledge and improve process.</p> </td></tr></table></div></div></div></div>");
    $templateCache.put('/angular/jade-html/views/new_user_onboard', "<!--extends ../_to_be_wired_in/_layouts/page_logged_in--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"application\"><div class=\"section row\"><div class=\"col-1\"></div><div class=\"col-10\"><div class=\"section row__label\"><div class=\"label\">Welcome to TEAM Mentor</div><ul class=\"display-inline\"><li class=\"full-width\"><button>Go to app</button></li></ul></div><div class=\"section row\"><div class=\"article result\"><div class=\"summary\"><h2>Search</h2><p>TEAM Mentor 4.0 has faster and more reliable search results. Search the database by filter, issue or technology.</p></div></div><div class=\"article result\"><div class=\"summary\"><h2>Navigate</h2><p>Not sure where to start? You can browse our index and find groups of articles that cover entire topics.</p></div></div><div class=\"article result\"><div class=\"summary\"><h2>Filters</h2><p>Filter your results to find articles that directly relate to you. You can filter by technology, phase and type.</p></div></div></div></div><div class=\"col-1\"></div></div></div>");
    $templateCache.put('/angular/jade-html/views/pwd_forgot', "<!--extends ../_to_be_wired_in/_layouts/page_logged_out--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><!--mixin forgot-pwd-form.section.row__label .label Forgot your password? .section.row form#forgot-pwd-form(action='#') .section.row .col-8.input-field +email-input .col-4.button-field br +get-password-button --><div class=\"section row\"><div class=\"col-4\"><div class=\"section tm-summary\"><div class=\"section row__label\"><div class=\"label\">With TEAM Mentor, you can...</div></div><div class=\"section row\"><table><tr><td><div class=\"fix-vulnerabilities\"></div></td><td><p>Fix vulnerabilities quicker than ever before.</p> </td></tr><tr><td><div class=\"reduce-vulnerabilities\"></div></td><td><p>Reduce the number of vulnerabilities over time.</p> </td></tr><tr><td><div class=\"improve-process\"></div></td><td><p>Expand the development team&#39;s knowledge and improve process.</p> </td></tr></table></div></div></div><div class=\"col-8\"><pwd-forgot-form></pwd-forgot-form></div></div>");
    ...
    $templateCache.put('/angular/jade-html/views/user/index', "<!--.application--><div ng-controller=\"Index_Controller\"><div class=\"main\"><div class=\"section row\"><div class=\"\{\{column_Left}}\"><queries></queries></div><div class=\"\{\{column_Middle}}\"><results></results><breadcrumbs></breadcrumbs><articles></articles><div class=\"section row pagination\"><div class=\"previous\"><span class=\"icon-Arrow-Left\"></span></div><div class=\"number\"><select><option value=\"1\">1</option><option value=\"2\">2</option><option value=\"3\">3</option></select></div><div class=\"next\"><span class=\"icon-Arrow-Right\"></span></div></div></div><div class=\"\{\{column_Right}}\"><filters></filters></div></div></div></div>");
    $templateCache.put('/angular/jade-html/views/user/main', "<!DOCTYPE html><html lang=\"en\"><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><html lang=\"en-US\"></html><head><title>TEAM Mentor 4.0</title><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><meta name=\"description\" content=\"\"><meta name=\"author\" content=\"\"><link rel=\"icon\" href=\"/assets/favicons/favicon.ico\"><link href=\"/css/flare-stylesheet.css\" rel=\"stylesheet\"></head><body><div ng-controller=\"Search_Bar_Controller\" class=\"search\"><form ng-submit=\"submit()\"><ul><li><div class=\"logo\"></div></li></ul><select ng-model=\"selected_Technology\" ng-change=\"select_Technology(selected_Technology)\" ng-options=\"technology as technology.title for technology in technologies\"></select><input id=\"search-text\" type=\"text\" ng-model=\"text\" placeholder=\"Search TEAM Mentor\" class=\"search-input\"><button id=\"search-button\" type=\"submit\" class=\"btn-search\"><icon class=\"Search\"></icon></button></form></div><div class=\"application\"></div><div class=\"main\"><div class=\"section row\"><div class=\"section row__label\"><div class=\"label\">Popular Search Terms</div></div><div class=\"section row\"><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"article search-term\"><a href=\"app-keyword-search\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>Search Term</span></a></div><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"article search-term\"><a href=\"app-keyword-search\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>Search Term</span></a></div><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"article search-term\"><a href=\"app-keyword-search\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>Search Term</span></a></div><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"article search-term\"><a href=\"app-keyword-search\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>Search Term</span></a></div><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"article search-term\"><a href=\"app-keyword-search\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>Search Term</span></a></div><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"article search-term\"><a href=\"app-keyword-search\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>Search Term</span></a></div></div></div><div class=\"section row\"><div class=\"section row__label\"><div class=\"label\">Recently Viewed Articles</div></div><div class=\"section row\"><article-box></article-box><article-box></article-box><!--include result_article.jade--><!--include result_article.jade--><!--include result_article.jade--><!--include result_article.jade--></div></div><div class=\"section row\"><div class=\"section row__label\"><div class=\"label\">Top Articles</div></div><div class=\"section row\"><article-box></article-box><article-box></article-box><!--include result_article.jade--><!--include result_article.jade--><!--include result_article.jade--><!--include result_article.jade--></div></div></div></body></html>");
    return $templateCache.put('/angular/jade-html/views/user', "<!--extends ../_to_be_wired_in/_layouts/page_logged_in--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- User Inputs--><div class=\"application\"><div class=\"main\"><div class=\"section row\"><div class=\"col-3\"><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"section row__label\"><div class=\"label\">@username</div></div><div class=\"section row\"><form><input type=\"text\" name=\"name\" value=\"First name, Last name\"/><input type=\"text\" name=\"work\" value=\"Position, Company\"/><input type=\"email\" name=\"email\" value=\"Email\"/><button type=\"submit\"><span class=\"icon-Tick\"></span></button></form></div></div><div class=\"col-9\"><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><div class=\"section row__label\"><div class=\"label\">Saved Items</div><ul class=\"display-inline\"><li><a href=\"\" class=\"button btn-result icon-Filter\"></a></li><li><button title=\"Delete results from Collection\" class=\"btn-result icon-Delete\"></button></li><li><button title=\"Share results\" class=\"btn-result icon-Share\"></button></li></ul></div><div class=\"section row\"><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><div class=\"article search-term\"><a href=\"app-keyword-search\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>Search Term</span></a></div><ul class=\"display-inline\"><li><button title=\"Delete\" class=\"btn-minor icon-Delete\"></button></li><li><button title=\"Share\" class=\"btn-minor icon-Share\"></button></li></ul></div><div class=\"section row\"><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><div class=\"article result\"><div class=\"metadata\"><ul><li><br/></li><!--li+filter-icon('Type', result.type)--><!--li+filter-icon('Phase', result.phase)--><!--li+filter-icon('Technology', result.technology)--></ul></div><div class=\"summary\"><a href=\"#\"><h3 id=\"article-headline\">Article Headline</h3></a><p>Article Summary</p><ul class=\"display-inline\"><li><button title=\"Delete\" class=\"btn-minor icon-Delete\"></button></li><li><button title=\"Share\" class=\"btn-minor icon-Share\"></button></li></ul></div></div></div><div class=\"footer\"><a href=\"http://www.securityinnovation.com/\" target=\"_blank\"><div class=\"si-logo\"></div></a><div class=\"icons\"><ul><li><div class=\"label no-underline\">TEAM Mentor 4.0</div></li><li><a href=\"mailto:support@securityinnovation.com\" title=\"Email\"><span title=\"Mail\" class=\"icon-Mail\"></span></a></li><li><a href=\"http://www.twitter.com/SecInnovation\" target=\"_blank\" title=\"Twitter\"><span title=\"Twitter\" class=\"icon-Twitter\"></span></a></li><li><a id=\"terms-and-conditions\" ui-sref=\"terms_and_conditions\"><span title=\"Terms &amp; Conditions\" class=\"icon-Paperclip\"></span></a></li></ul></div></div></div></div></div></div>");
  });
...
(function() {
  ...
  user_Components = ['article_box', 'articles', 'breadcrumbs', 'filters', 'queries', 'queries_history', 'results', 'search_bar'];
...
(function() {
  angular.module('TM_App').controller('Index_Controller', function($scope) {
    return using($scope, function() {
      ...
      return this.$on('view_Filters', (function(_this) {
        return function(event, data) {
          if (data) {
...
(function() {
  angular.module('TM_App').controller('Results_Controller', function($scope, $rootScope, query_Service) {
    ...
    return $scope.clear_Filter = function(key) {
