...
(function() {
  ...
  app.run(function($templateCache) {
    ...
    $templateCache.put('/angular/jade-html/component/navigation/left_navigation', "<!-- Application Icons--><!--mixin filter-icon--><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><aside ng-controller=\"User_Navigation_Controller\"><ul><li><div class=\"application-logo\"></div></li><li><a ui-sref=\"main\"><span class=\"icon-Home\"></span></a></li><li><!--a(ui-sref=\"queries\")+index-icon--><a ng-click=\"open_Query_State()\"><span title=\"Index\" class=\"icon-Index\"></span></a></li><li><a ui-sref=\"docs\"><span title=\"Documentation\" class=\"icon-Info\"></span></a></li><li><a href=\"/angular/guest/index\"><span title=\"Logout\" class=\"icon-Logout\"></span></a><!--a(ui-sref=\"logout\")--></li></ul></aside>");
    ...
    $templateCache.put('/angular/jade-html/component/user/article_box', "<article ng-controller=\"Article_Box_Controller\" class=\"result\"><div class=\"metadata\"><ul><li><div id=\"icon-technology\" ng-bind-html=\"icon_Technology\"></div></li><li><div id=\"icon-technology\" ng-bind-html=\"icon_Type\"></div></li><li><div id=\"icon-technology\" ng-bind-html=\"icon_Phase\"></div></li></ul></div><div class=\"summary\"><a ng-href=\"\{\{article.url}}\" id=\"\{\{article.id}}\"><h3 id=\"article-headline\">\{\{article.title}} \{\{title}}</h3></a><p>\{\{article.summary}} ...</p></div></article>");
    $templateCache.put('/angular/jade-html/component/user/articles', "<!-- Application Icons--><!--mixin filter-icon--><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><div ng-controller=\"Articles_Controller\"><section class=\"row\"><article-box ng-repeat=\"article in articles\"><!--.metadataul li //+show-icon('Technology',result.technology) li //+show-icon('Type', result.type) li //+show-icon('Phase', result.phase) //li +save-button //li +share-button--><!--.summarya(ng-href='\{\{article.url}}', id='\{\{article.id}}') h3#article-headline \{\{article.title}} p \{\{article.summary}} ...--></article-box><!--each result,index in results.take(10)if result && result.id && result.title article.result .metadata ul //li span.label.no-underline +tick-icon span   Seen li +show-icon('Technology',result.technology) li +show-icon('Type', result.type) li +show-icon('Phase', result.phase) //li +save-button //li +share-button .summary a(href='/angular/user/article/' + result.id.remove('article-') + '/' + result.title.replace(/ /g, '-').remove('.'), id=result.id) h3#article-headline= result.title p= result.summary + '...'--></section></div>");
    $templateCache.put('/angular/jade-html/component/user/filters', "<div ng-controller=\"Filters_Controller\"><div id=\"filters\" ng-repeat=\"filter in filters\"><section class=\"row__label\"><div class=\"label\"><icon class=\"Filter\"></icon><span class=\"text\"> \{\{filter.title}}</span></div></section><section class=\"row\"><filter-item ng-repeat=\"result in filter.results\"><a ng-href=\"#\" ng-click=\"apply_Filter(result.id, result.title)\" ng-show=\"result.size &gt;0\"><div id=\"filter-icon\" ng-bind-html=\"result.icon\"></div><span class=\"badge\">\{\{result.size}}</span></a></filter-item></section></div></div>");
    ...
    $templateCache.put('/angular/jade-html/views/docs', "<main ng-controller=\"Help_Controller\" class=\"help\"><section class=\"row\"><div class=\"col-3\"><help-navigation></help-navigation></div><div class=\"col-9\"><article><div id=\"help\"><h1 id=\"help-title\">\{\{title}}</h1><help-content ng-bind-html=\"content\"></help-content></div></article></div></section></main>");
    ...
    $templateCache.put('/angular/jade-html/views/guest/sign_up', "<!-- Application Icons--><!--mixin filter-icon--><!--  span.icon-Filter--><!-- Filter Icons--><!-- filter icons--><!-- Getting Started--><!-- User Inputs--><!--mixin forgot-pwd-formsection.row__label .label Forgot your password? section.row form#forgot-pwd-form(action='#') section.row .col-8.input-field +email-input .col-4.button-field br +get-password-button --><section class=\"row\"><div class=\"col-4\"><section class=\"tm-summary\"><section class=\"row__label\"><div class=\"label\">With TEAM Mentor, you can...</div></section><section class=\"row\"><table><tr><td><div class=\"fix-vulnerabilities\"></div></td><td><p>Fix vulnerabilities quicker than ever before.</p> </td></tr><tr><td><div class=\"reduce-vulnerabilities\"></div></td><td><p>Reduce the number of vulnerabilities over time.</p> </td></tr><tr><td><div class=\"improve-process\"></div></td><td><p>Expand the development team&#39;s knowledge and improve process.</p> </td></tr></table></section></section></div><div class=\"col-8\"><section class=\"getting-started\"><!-- Getting Started--><!-- User Inputs--><div ng-controller=\"Signup_Controller\"><section class=\"row__label\"><div class=\"label\">Sign Up</div></section><section ng-show=\"showErrorMessage()\" class=\"row\"><div role=\"alert\" class=\"alert alert-bad\"><div id=\"message\"><span class=\"alert-icon\">!</span><span class=\"alert-text\">Error:  \{\{errorMessage}}</span></div></div></section><section ng-show=\"showInfoMessage()\" class=\"row\"><div role=\"alert\" class=\"alert alert-ok\"><div id=\"message\"><span class=\"alert-icon\">|</span><span class=\"alert-text\">Info:  \{\{infoMessage}}</span></div></div></section><section class=\"row\"><form id=\"sign-up-form\" role=\"form\" ng-submit=\"signup()\"><div class=\"input-field\"><label>Username</label><input type=\"text\" id=\"username\" placeholder=\"Username\" ng-model=\"username\" required=\"required\"/></div><div class=\"input-field\"><label for=\"email\">Email Address</label><input type=\"email\" id=\"email\" name=\"email\" ng-model=\"email\" placeholder=\"Email Address\" value=\"\" required=\"required\" maxlength=\"256\"/></div><div class=\"input-field\"><label for=\"password\">Password</label><input type=\"password\" id=\"password\" placeholder=\"Password\" ng-model=\"password\" required=\"required\" maxlength=\"256\"/></div><div class=\"input-field\"><label for=\"confirmpassword\">Confirm Password</label><input type=\"password\" id=\"confirmpassword\" name=\"confirmpassword\" ng-model=\"confirmpassword\" placeholder=\"Password\" value=\"\" required=\"required\" maxlength=\"256\"/></div><div class=\"input-field\"><label for=\"firstname\">First Name</label><input type=\"text\" id=\"firstname\" name=\"firstname\" ng-model=\"firstname\" placeholder=\"First Name\" value=\"\" required=\"required\" maxlength=\"100\"/></div><div class=\"input-field\"><label for=\"lastname\">Last Name</label><input type=\"text\" id=\"lastname\" name=\"lastname\" ng-model=\"lastname\" placeholder=\"Last Name\" value=\"\" required=\"required\" maxlength=\"100\"/></div><div class=\"input-field\"><label>Company</label><input type=\"text\" id=\"company\" placeholder=\"Company\"/></div><div class=\"input-field\"><label>Title</label><input type=\"text\" id=\"title\" placeholder=\"Title\"/></div><div class=\"input-field\"><label for=\"country\">Country</label><input type=\"text\" id=\"country\" name=\"country\" ng-model=\"country\" placeholder=\"Country\" value=\"\" required=\"required\" maxlength=\"100\"/></div><div class=\"input-field\"><label for=\"state\">State</label><input type=\"text\" id=\"state\" name=\"state\" ng-model=\"state\" placeholder=\"State\" value=\"\" maxlength=\"100\"/><q></q></div><div class=\"conditions\"><p>By signing up, you agree to our <a href=\"/misc/terms-and-conditions\">Terms and Conditions</a>.</p> </div><div class=\"button-field\"><button type=\"submit\" id=\"btn-sign-up\" class=\"full-width\">Sign Up</button></div></form></section></div></section></div></section>");
    ...
    $templateCache.put('/angular/jade-html/views/user/articles', "<main><section class=\"row\"><div class=\"col-12\"><h2>query-dd98c2d701d8</h2><articles></articles></div></section></main>");
    $templateCache.put('/angular/jade-html/views/user/index', "<!--.application--><main><section class=\"row\"><div class=\"col-3\"><small><div>queries</div><!--queries--></small></div><div class=\"col-6\"><div>queries_breadcrumbs</div><div>articles</div><!--queries_breadcrumbs--><!--articles--></div><div class=\"col-3\"><div>filters<!--filters--></div></div></section></main>");
...
(function() {
  ...
  user_Components = ['article_box', 'articles', 'filters', 'queries_breadcrumbs', 'queries_history', 'search_bar'];
