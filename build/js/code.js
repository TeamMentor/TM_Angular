...
(function() {
  ...
  app.run(function($templateCache) {
    ...
    $templateCache.put('/angular/jade-html/component/start_view', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"section row\"><div class=\"section row__label\"><div class=\"label\">Popular Search Terms</div></div><div ng-controller=\"Search_Controller\" class=\"section row\"><div ng-repeat=\"search in top_Search\" class=\"article search-term\"><a href=\"\{\{search.url}}\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>\{\{search.title}}</span></a></div></div></div><div class=\"section row\"><div class=\"section row__label\"><div ng-show=\"recent_Articles.length &gt; 0\" class=\"label\">Recently Viewed Articles</div></div><div class=\"section row\"><article-box ng-repeat=\"article in recent_Articles\" class=\"article-box\"></article-box></div></div><div class=\"section row\"><div class=\"section row__label\"><div class=\"label\">Top Articles</div></div><div class=\"section row\"><article-box ng-repeat=\"article in top_Articles\" class=\"article-box\"></article-box></div></div>");
    ...
    $templateCache.put('/angular/jade-html/views/docs', "<div ng-controller=\"Help_Controller\" class=\"main help\"><div class=\"section row\"><div class=\"col-3 application-scroll\"><help-navigation></help-navigation></div><div class=\"col-9 application-scroll\"><div id=\"help\" class=\"section row__article\"><h1 id=\"help-title\">\{\{title}}</h1><help-content ng-bind-html=\"content\"></help-content></div></div></div></div>");
    ...
    $templateCache.put('/angular/jade-html/views/user/index', "<div ng-controller=\"Index_Controller\" class=\"main\"><div class=\"\{\{column_Left}} application-scroll left-col\"><queries></queries></div><div class=\"\{\{column_Middle}} middle-col\"><div class=\"fixed-results\"><results></results><breadcrumbs></breadcrumbs><filters_active></filters_active></div><div class=\"scrolling-results application-scroll\"><articles></articles><pagination></pagination></div></div><div class=\"\{\{column_Right}} application-scroll right-col\"><filters class=\"filters\"></filters></div></div>");
    $templateCache.put('/angular/jade-html/views/user/main', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- Terms and Conditions Navigation--><div class=\"application\"></div><div class=\"main\"><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"section row\"><div class=\"section row__label\"><div class=\"label\">Popular Search Terms</div></div><div ng-controller=\"Search_Controller\" class=\"section row\"><div ng-repeat=\"search in top_Search\" class=\"article search-term\"><a href=\"\{\{search.url}}\"><span title=\"Search\" class=\"icon-Search\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span></span><span>\{\{search.title}}</span></a></div></div></div><div class=\"section row\"><div class=\"section row__label\"><div ng-show=\"recent_Articles.length &gt; 0\" class=\"label\">Recently Viewed Articles</div></div><div class=\"section row\"><article-box ng-repeat=\"article in recent_Articles\" class=\"article-box\"></article-box></div></div><div class=\"section row\"><div class=\"section row__label\"><div class=\"label\">Top Articles</div></div><div class=\"section row\"><article-box ng-repeat=\"article in top_Articles\" class=\"article-box\"></article-box></div></div></div>");
