...
(function() {
  ...
  app.run(function($templateCache) {
    ...
    $templateCache.put('/angular/jade-html/component/guest/pwd_forgot_form', "<!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><div ng-controller=\"Pwd_Forgot_Controller\"><div class=\"section row__label\"><div class=\"label\">Forgot your password?</div></div><div class=\"section row\"><form id=\"forgot-pwd-form\" ng-submit=\"get_Password()\"><div class=\"section row\"><div class=\"col-8 input-field\"><label for=\"email\">Email Address</label><input type=\"email\" id=\"email\" ng-model=\"email\" placeholder=\"Email Address\" required=\"required\" maxlength=\"256\"/></div><div class=\"col-4 button-field\"><button type=\"submit\" id=\"btn-get-password\" class=\"full-width\">Retrieve password</button></div></div></form></div><alert-ok></alert-ok></div>");
    ...
    $templateCache.put('/angular/jade-html/component/user/active_filter', "<div class=\"active-filter\"><span><span class=\"icon\">#</span><span class=\"text\">Active Filter</span></span><span class=\"close\"><a href=\"#\">x</a></span></div>");
    ...
    $templateCache.put('/angular/jade-html/component/user/filters_active', "<div class=\"section row\"><div class=\"active-filter\"><span><span class=\"icon\">#</span><span class=\"text\">Active Filter</span></span><span class=\"close\"><a href=\"#\">x</a></span></div></div>");
    ...
    $templateCache.put('/angular/jade-html/views/guest/pwd_forgot', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!--mixin forgot-pwd-form.section.row__label .label Forgot your password? .section.row form#forgot-pwd-form(action='#') .section.row .col-8.input-field +email-input .col-4.button-field br +get-password-button --><div class=\"section row\"><div class=\"col-7\"><pwd-forgot-form></pwd-forgot-form></div><div class=\"col-1\"></div><div class=\"col-4\"><div class=\"section tm-summary\"><div class=\"section row__label\"><div class=\"label\">With TEAM Mentor, you can...</div></div><div class=\"section row\"><table><tr><td><div class=\"fix-vulnerabilities\"></div></td><td><p>Fix vulnerabilities quicker than ever before.</p> </td></tr><tr><td><div class=\"reduce-vulnerabilities\"></div></td><td><p>Reduce the number of vulnerabilities over time.</p> </td></tr><tr><td><div class=\"improve-process\"></div></td><td><p>Expand the development team&#39;s knowledge and improve process.</p> </td></tr></table></div></div></div></div>");
    ...
    $templateCache.put('/angular/jade-html/views/user/index', "<!--.application--><div ng-controller=\"Index_Controller\"><div class=\"main\"><div class=\"section row\"><div class=\"\{\{column_Left}}\"><queries></queries></div><div class=\"\{\{column_Middle}}\"><results></results><breadcrumbs></breadcrumbs><div class=\"section row\"><div class=\"active-filter\"><span><span class=\"icon\">#</span><span class=\"text\">Active Filter</span></span><span class=\"close\"><a href=\"#\">x</a></span></div></div><articles></articles><pagination></pagination></div><div class=\"\{\{column_Right}}\"><filters></filters></div></div></div></div>");
