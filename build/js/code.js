...
(function() {
  ...
  TM_API = (function() {
    function TM_API(q, http, timeout) {
      ...
      this.query_tree_filtered = bind(this.query_tree_filtered, this);
    ...
    TM_API.prototype.query_tree_filtered = function(id, filter, callback) {
      var url;
      if (id && filter && callback) {
        if (this.cache_Query_Tree[id + filter]) {
          return callback(this.cache_Query_Tree[id + filter]);
        }
        url = "/api/data/query_tree_filtered/" + id + "/" + filter;
        return this.$http.get(url).success((function(_this) {
          return function(data) {
            _this.cache_Query_Tree[id + filter] = data;
            return callback(data);
          };
        })(this));
      }
  ...
  angular.module('TM_App').controller('Articles_Controller', function($scope, query_Service, $location, TM_API) {
    ...
    $scope.$on('filter_data', function(event, data) {
      ...
      if (data != null ? data.results : void 0) {
        ...
        return $scope.$broadcast('show_page', 0);
      }
    });
    $scope.$on('show_page', function(event, page) {
...
(function() {
  angular.module('TM_App').controller('Pagination_Controller', function($scope, $rootScope, query_Service) {
    $scope.currentPage = 1;
    $scope.show_Page = function() {
      return $rootScope.$broadcast('show_page', $scope.currentPage);
    };
    $scope.previous_Page = function() {
      $scope.currentPage--;
      return $scope.show_Page();
    };
    return $scope.next_Page = function() {
      $scope.currentPage++;
      return $scope.show_Page();
    };
  });
