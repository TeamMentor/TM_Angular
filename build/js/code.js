...
(function() {
  ...
  app.run(function($templateCache) {
    ...
    $templateCache.put('/angular/jade-html/component/navigation/left_navigation', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><aside ng-controller=\"User_Navigation_Controller\"><ul><li ng-show=\"show_Loading_Image\"><icon class=\"Loading rotating\"></icon></li><li><!--a(ui-sref=\"queries\")--><a href=\"index\" ng-click=\"open_Query_State()\"><icon class=\"Home\"></icon></a></li><li><a ui-sref=\"main\"><icon class=\"User\"></icon></a></li><li><a ui-sref=\"docs\"><icon class=\"Info\"></icon></a></li><li><a href=\"#\"><span class=\"text\">!</span></a></li><li><a href=\"/angular/guest/logout\"><icon class=\"Logout\"></icon></a><!--a(ui-sref=\"logout\")--></li></ul></aside>");
    ...
    $templateCache.put('/angular/jade-html/component/user/found_issue', "<div class=\"found-issue\"><span class=\"alert-text\">Found an issue?  <a href=\"#\">Contact  </a>our team.</span><span class=\"close\"><a href=\"#\"><icon class=\"Close\"></icon></a></span></div>");
    ...
    $templateCache.put('/angular/jade-html/component/user/queries', "<!--include ../../mixins/icons.jade--><div ng-controller=\"Queries_Controller\" ng-show=\"visible\"><dl><dt><p id=\"query_title\">\{\{title}}</p><span class=\"sub-nav__icon\"><a ng-click=\"show_Previous_Query()\"><icon class=\"Arrow-Left\"></icon></a></span></dt><div id=\"containers\" class=\"scroll\"><div ng-repeat=\"container in containers\"><!--if container.size > 0--><a href=\"#\" id=\"\{\{container.id}}\" ng-click=\"load_Query(container.id)\" ng-show=\"container.size &gt;0\"><dd><span class=\"text\">\{\{container.title}}</span><span class=\"badge\">\{\{container.size}}</span></dd></a></div></div></dl></div>");
    ...
    $templateCache.put('/angular/jade-html/views/new_user_onboard', "<!--extends ../_to_be_wired_in/_layouts/page_logged_in--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><div class=\"main\"><div class=\"section row\"><div class=\"col-1\"></div><div class=\"col-10\"><div class=\"section row__label\"><div class=\"label\">Welcome to TEAM Mentor</div></div><div class=\"section row\"><div class=\"col-4\"><div class=\"article-box\"><div class=\"result\"><div class=\"summary\"><br/><h2>Search</h2><br/><p>TEAM Mentor 4.0 has faster and more reliable search results. Search the database by filter, issue or technology.</p></div></div></div></div><div class=\"col-4\"><div class=\"article-box\"><div class=\"result\"><div class=\"summary\"><br/><h2>Navigate</h2><br/><p>Not sure where to start? You can browse our index and find groups of articles that cover entire topics.</p></div></div></div></div><div class=\"col-4\"><div class=\"article-box\"><div class=\"result\"><div class=\"summary\"><br/><h2>Filters</h2><br/><p>Filter your results to find articles that directly relate to you. You can filter by technology, phase and type.</p></div></div></div></div></div></div><div class=\"col-1\"></div></div></div>");
    ...
    $templateCache.put('/angular/jade-html/views/user/article', "<!--include ../mixins/globals--><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><div class=\"main\"><article></article><!--include ../component/article.jade--></div>");
    ...
    $templateCache.put('/angular/jade-html/views/user/index', "<div ng-controller=\"Index_Controller\" class=\"main\"><loading_bar></loading_bar><div class=\"\{\{column_Left}} application-scroll left-col\"><queries></queries><div class=\"found-issue\"><span class=\"alert-text\">Found an issue?  <a href=\"#\">Contact  </a>our team.</span><span class=\"close\"><a href=\"#\"><icon class=\"Close\"></icon></a></span></div></div><div class=\"\{\{column_Middle}} middle-col\"><breadcrumbs></breadcrumbs><results></results><filters_active></filters_active><div class=\"scrolling-results\"><articles></articles><pagination></pagination></div></div><div class=\"\{\{column_Right}} application-scroll right-col\"><filters class=\"filters\"></filters></div></div>");
    $templateCache.put('/angular/jade-html/views/user/main', "<!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><!--mixin save-results-buttonbutton.btn-result.icon-Save(title='Save results to Collection') --><!--mixin delete-results-buttonbutton.btn-result.icon-Delete(title='Delete results from Collection') --><!--mixin share-results-buttonbutton.btn-result.icon-Share(title='Share results') --><!-- Getting Started--><!-- Terms and Conditions Navigation--><div class=\"main\"><div class=\"col-3\"></div><div class=\"col-6\"><!-- Application Icons--><!-- Filter Icons--><!-- filter icons--><div class=\"section row\"><div class=\"section row__label\"><div class=\"label\">Popular Search Terms</div></div><div ng-controller=\"Search_Controller\" class=\"section row\"><div ng-repeat=\"search in top_Search\" class=\"search-term\"><span class=\"icon\"><icon class=\"Star\"></icon></span><span class=\"link\"><a href=\"\{\{search.url}}\"><span>\{\{search.title}}</span></a></span></div></div></div><div ng-controller=\"Article_Controller\"><div class=\"section row\"><div class=\"section row__label\"><div ng-show=\"recent_Articles.length &gt; 0\" class=\"label\">Recently Viewed Articles</div></div><div class=\"section row\"><article-box ng-repeat=\"article in recent_Articles\" class=\"article-box user\"></article-box></div></div><div class=\"section row\"><div class=\"section row__label\"><div class=\"label\">Top Articles</div></div><div class=\"section row\"><article-box ng-repeat=\"article in top_Articles\" class=\"article-box user article-box\"></article-box></div></div></div></div><div class=\"col-3\"></div></div>");
