...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (article_Html, phase, technology, title, type) {
buf.push("<!--extends ../_to_be_wired_in/_layouts/page_logged_in-->");
...
buf.push("<div class=\"application\"><!--include ../component/left_navigation.jade--><!--include ../component/filters.jade--><main><section class=\"row\"><div class=\"col-2\"></div><div class=\"col-8\"><section class=\"row__article\"><h1>" + (jade.escape(null == (jade_interp = title) ? "" : jade_interp)) + "</h1><div id=\"html\" class=\"article-content\">" + (null == (jade_interp = article_Html) ? "" : jade_interp) + "</div><ul class=\"display-inline\"><li>");
jade_mixins["filter-icon"]('Technology', technology);
buf.push("</li><li>");
jade_mixins["filter-icon"]('Type', type);
buf.push("</li><li>");
jade_mixins["filter-icon"]('Phase', phase);
buf.push("</li></ul></section></div><div class=\"col-2\"></div></section>");
jade_mixins["copyright"]();
buf.push("</main></div>");}.call(this,"article_Html" in locals_for_with?locals_for_with.article_Html:typeof article_Html!=="undefined"?article_Html:undefined,"phase" in locals_for_with?locals_for_with.phase:typeof phase!=="undefined"?phase:undefined,"technology" in locals_for_with?locals_for_with.technology:typeof technology!=="undefined"?technology:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined,"type" in locals_for_with?locals_for_with.type:typeof type!=="undefined"?type:undefined));;return buf.join("");
}
...
buf.push("</span></dt><dd><a href=\"#\">Item One</a></dd><dd><a href=\"#\">Item Two</a></dd><dd><a href=\"#\">Item Three</a></dd></dl></div><div class=\"col-9\"><section class=\"row\">");
if ( results)
{
...
buf.push("</section></div></section></main></div>");}.call(this,"results" in locals_for_with?locals_for_with.results:typeof results!=="undefined"?results:undefined,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined));;return buf.join("");
}
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (content, library, title) {
buf.push("<!--extends ../_to_be_wired_in/_layouts/page_logged_in-->");
jade_mixins["tm-support-email"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<a id=\"tm-support-email\" href=\"mailto:support@securityinnovation.com\">support@securityinnovation.com</a>");
...
buf.push("<dl class=\"help\"><dt class=\"vertical-align\"><span class=\"label no-underline\">" + (jade.escape(null == (jade_interp = view.Title) ? "" : jade_interp)) + "</span></dt><div class=\"scroll\"></div>");
...
buf.push("<div class=\"application\"><!--include ../component/left_navigation.jade--><!--include ../component/filters.jade--><main><section class=\"row\"><div class=\"col-3\"><h1>docs nav</h1>");
jade_mixins["help-navigation"]();
buf.push("</div><div class=\"col-9\"><article><h1>docs Content</h1>");
jade_mixins["help-content"]();
buf.push("</article></div></section></main></div>");}.call(this,"content" in locals_for_with?locals_for_with.content:typeof content!=="undefined"?content:undefined,"library" in locals_for_with?locals_for_with.library:typeof library!=="undefined"?library:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined));;return buf.join("");
}
...
function jade_forgot_pwd(locals) {
var buf = [];
var jade_mixins = {};
var jade_interp;
...
jade_mixins["forgot-pwd-form"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<section class=\"row__label\"><div class=\"label\">Forgot your password?</div></section><section class=\"row\"><form id=\"forgot-pwd-form\" action=\"#\"><section class=\"row\"><div class=\"col-8 input-field\">");
...
buf.push("</div></section></div>");}.call(this,"viewModel" in locals_for_with?locals_for_with.viewModel:typeof viewModel!=="undefined"?viewModel:undefined));;return buf.join("");
}
...
buf.push("</section></section><section class=\"row\"><section class=\"row__label\"><div class=\"label\">Top Articles</div></section><section class=\"row\">");
if ( results)
{
// iterate results.take(10)
;(function(){
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (containers, href, results, title, undefined) {
...
buf.push("</div><div class=\"col-9\"><section class=\"row__label\">");
if ( results)
{
if ( results.size() > 25)
{
...
buf.push("<ul class=\"display-inline\"><li><!--a.button.btn-result.icon-Filter(href='#right-nav') aaaaaaa--><a href=\"\" class=\"button btn-result icon-Filter\"></a></li><!--li+save-results-button--><!--li+share-results-button--></ul>");
}
...
buf.push("</section><section class=\"row\"><section class=\"row pagination\"><div class=\"previous\">");
jade_mixins["back-icon"]();
...
buf.push("</div></section></section></div></section></main></div></body></html>");}.call(this,"containers" in locals_for_with?locals_for_with.containers:typeof containers!=="undefined"?containers:undefined,"href" in locals_for_with?locals_for_with.href:typeof href!=="undefined"?href:undefined,"results" in locals_for_with?locals_for_with.results:typeof results!=="undefined"?results:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined));;return buf.join("");
}
...
buf.push("<div class=\"application\"><aside id=\"left-nav\"><ul><li><!--a(ui-sref=\"main\")--><a href=\"#main\">");
...
buf.push("</a></li></ul></aside><aside id=\"right-nav\">");
if ( filters)
{
...
if ( result.size > 0)
{
buf.push("<!--a(href=href + '/'+result.id)--><input type=\"checkbox\"" + (jade.attr("id", result.title, true, true)) + "><label" + (jade.attr("for", result.title, true, true)) + ">");
...
buf.push("</aside><main><section class=\"row__label\">");
if ( results)
{
if ( results.size() > 25)
{
...
buf.push("</section></main></div></body></html>");}.call(this,"filters" in locals_for_with?locals_for_with.filters:typeof filters!=="undefined"?filters:undefined,"results" in locals_for_with?locals_for_with.results:typeof results!=="undefined"?results:undefined,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined));;return buf.join("");
}
...
buf.push("<div class=\"application\"><!--include ../component/left_navigation.jade--><!--include ../component/filters.jade--><main><section class=\"row\"><div class=\"col-3\"><section class=\"row__label\"><div class=\"label\">@username</div></section><section class=\"row\"><form><input type=\"text\" name=\"name\" value=\"First name, Last name\"/><input type=\"text\" name=\"work\" value=\"Position, Company\"/><input type=\"email\" name=\"email\" value=\"Email\"/><button type=\"submit\">");
jade_mixins["tick-icon"]();
buf.push("</button></form></section></div><div class=\"col-9\"><section class=\"row__label\"><div class=\"label\">Saved Items</div><ul class=\"display-inline\"><li><a href=\"\" class=\"button btn-result icon-Filter\"></a></li><li>");
jade_mixins["delete-results-button"]();
buf.push("</li><li>");
jade_mixins["share-results-button"]();
buf.push("</li></ul></section><section class=\"row\"><article class=\"search-term\"><a href=\"app-keyword-search\">");
jade_mixins["search-icon"]();
buf.push("<span>Search Term</span></a></article><ul class=\"display-inline\"><li>");
jade_mixins["delete-saved-button"]();
buf.push("</li><li>");
jade_mixins["share-saved-button"]();
buf.push("</li></ul></section><section class=\"row\"><article class=\"result\"><div class=\"metadata\"><ul><li><br/></li><!--li+filter-icon('Type', result.type)--><!--li+filter-icon('Phase', result.phase)--><!--li+filter-icon('Technology', result.technology)--></ul></div><div class=\"summary\"><a href=\"#\"><h3 id=\"article-headline\">Article Headline</h3></a><p>Article Summary</p><ul class=\"display-inline\"><li>");
jade_mixins["delete-saved-button"]();
buf.push("</li><li>");
jade_mixins["share-saved-button"]();
