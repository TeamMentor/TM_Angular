...
buf.push("<div class=\"application\"><!--+left-navigation--><!--+filters-div--><main>");
...
buf.push("<!--extends ../_to_be_wired_in/_layouts/page_logged_in-->");
jade_mixins["article"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<section class=\"row\"><div class=\"col-2\"></div><div class=\"col-8\"><section class=\"row__article\"><h1>" + (jade.escape(null == (jade_interp = title) ? "" : jade_interp)) + "</h1><div id=\"html\" class=\"article-content\">" + (null == (jade_interp = article_Html) ? "" : jade_interp) + "</div><ul class=\"display-inline\"><li>");
...
buf.push("</section>");}.call(this,"errorMessage" in locals_for_with?locals_for_with.errorMessage:typeof errorMessage!=="undefined"?errorMessage:undefined,"viewModel" in locals_for_with?locals_for_with.viewModel:typeof viewModel!=="undefined"?viewModel:undefined));;return buf.join("");
}
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (containers, filters, href, results, title) {
...
buf.push("<html lang=\"en-US\"></html><head><title>" + (jade.escape((jade_interp = head_title) == null ? '' : jade_interp)) + "</title><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><meta name=\"description\" content=\"\"><meta name=\"author\" content=\"\"><link rel=\"icon\" href=\"/assets/favicons/favicon.ico\"><link href=\"/css/custom-style-flare.css\" rel=\"stylesheet\"></head><body>");
...
if ( container.size > 0)
{
buf.push("<a" + (jade.attr("href", href + container.id, true, true)) + (jade.attr("id", container.id, true, true)) + "><dd><span class=\"text\">" + (jade.escape(null == (jade_interp = container.title) ? "" : jade_interp)) + "</span><span class=\"badge\">" + (jade.escape(null == (jade_interp = container.size) ? "" : jade_interp)) + "</span></dd></a>");
}
    }
...
buf.push("<a href=\"/flare/main-app-view\" class=\"logo application-logo\"></a><!--+search-bar--><div class=\"application\">");
jade_mixins["left-navigation"]();
jade_mixins["filters-div"]();
buf.push("<main><section class=\"row\"><div class=\"col-3\">");
...
buf.push("</section></div></section></main></div></body></html>");}.call(this,"containers" in locals_for_with?locals_for_with.containers:typeof containers!=="undefined"?containers:undefined,"filters" in locals_for_with?locals_for_with.filters:typeof filters!=="undefined"?filters:undefined,"href" in locals_for_with?locals_for_with.href:typeof href!=="undefined"?href:undefined,"results" in locals_for_with?locals_for_with.results:typeof results!=="undefined"?results:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined));;return buf.join("");
}
...
jade_mixins["articles-list"]();
jade_mixins["articles-list"]();
buf.push("</section></main></div>");}.call(this,"results" in locals_for_with?locals_for_with.results:typeof results!=="undefined"?results:undefined));;return buf.join("");
}
