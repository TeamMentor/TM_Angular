...
buf.push("<div class=\"application\"><!--include ../component/left_navigation.jade--><main>");
...
buf.push("<section class=\"row\"><div class=\"col-2\"></div><div class=\"col-8\"><section class=\"row__article\"><h1>{{article.title}}</h1><div id=\"html\" ng-bind-html=\"article_Html\" class=\"article-content\"></div><ul class=\"display-inline\"><li><div id=\"icon-technology\" ng-bind-html=\"icon_Technology\"></div></li><li><div id=\"icon-Type\" ng-bind-html=\"icon_Type\"></div></li><li><div id=\"icon-Phase\" ng-bind-html=\"icon_Phase\"></div></li></ul>");
jade_mixins["copyright"]();
buf.push("</section></div><div class=\"col-2\"></div></section></main>");;return buf.join("");
}
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (technology) {
jade_mixins["article-editor"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div class=\"col-9\"><section class=\"article-body\"><section class=\"row\"><form class=\"article-editor\"><input type=\"text\" name=\"article-title\" placeholder=\"Article Title\"/><textarea name=\"article-body\" placeholder=\"Article Body\"></textarea><section class=\"import-files\"><p>You can<a href=\"#\"> import</a> PDFs, images or Word documents.</p></section></form></section><section class=\"row__label\"><div class=\"label\">Directories</div><!-- This toggles the different editor functionalities for heirarchical structure.--><ul class=\"toggle-bar display-inline\"><form class=\"article-editor text-center\"><li class=\"one-third\"><input type=\"radio\" name=\"editor\" value=\"add\" id=\"add\"/><label for=\"add\" class=\"button btn-result icon-Add\"></label></li><li class=\"one-third\"><input type=\"radio\" name=\"editor\" value=\"edit\" id=\"edit\"/><label for=\"edit\" class=\"button btn-result icon-Edit\"></label></li><li class=\"one-third\"><input type=\"radio\" name=\"editor\" value=\"delete\" id=\"delete\"/><label for=\"delete\" class=\"button btn-result icon-Delete\"></label></li></form></ul></section><section class=\"row\"><ul class=\"display-inline\"><!-- This is for display before any action is taken--><li class=\"one-third\"><dl><dt><div class=\"label\">Container</div></dt></dl></li><!-- This should be used for when the user toggles the Add or Edit functionality--><li class=\"one-third\"><dl><dt><div class=\"label\">Container</div><span class=\"sub-nav__icon\">");
jade_mixins["back-icon"]();
buf.push("</span></dt><dd><a href=\"#\" class=\"active\">Directory</a></dd><dd><a href=\"#\">Directory</a></dd><dd><a href=\"#\">Directory</a></dd></dl></li><!-- This should be used if the user wants to delete a container--><li class=\"one-third\"><dl><dt><div class=\"label\">Container</div></dt><dd><form><label for=\"delete-directory\">Are you sure you want to delete this?</label><ul class=\"display-inline\"><li><button type=\"submit\" class=\"btn-editor\">");
jade_mixins["tick-icon"]();
buf.push("</button></li><li><button type=\"cancel\" class=\"btn-editor cancel\">");
jade_mixins["close-icon"]();
buf.push("</button></li></ul></form></dd></dl></li></ul></section><section class=\"row__label\"><div class=\"label\">Filters</div></section><section class=\"row\"><br/><form class=\"article-editor-grid\"><div><input type=\"checkbox\" id=\"filter1\"/><label for=\"filter1\">");
jade_mixins["all-icon"]();
buf.push("<span>Technology Independant</span></label></div><div><input type=\"checkbox\" id=\"filter2\"/><label for=\"filter2\">");
jade_mixins["android-icon"]();
buf.push("<span>Android</span></label></div><div><input type=\"checkbox\" id=\"filter3\"/><label for=\"filter3\">");
jade_mixins["scala-icon"]();
buf.push("<span>Scala</span></label></div><div><input type=\"checkbox\" id=\"filter4\"/><label for=\"filter4\">");
jade_mixins["wcf-icon"]();
buf.push("<span>WCF</span></label></div><div><input type=\"checkbox\" id=\"filter5\"/><label for=\"filter5\">");
jade_mixins["web-app-icon"]();
buf.push("<span>Web Application</span></label></div><div><input type=\"checkbox\" id=\"filter6\"/><label for=\"filter6\">");
jade_mixins["ios-icon"]();
buf.push("<span>iOS</span></label></div><div><input type=\"checkbox\" id=\"filter7\"/><label for=\"filter7\">");
jade_mixins["html5-icon"]();
buf.push("<span class=\"text\">HTML5</span></label></div></form></section><section class=\"row__label\"><div class=\"label\">Quality</div></section><section class=\"row\"><p>Quality slider, needs to be built with Angular so I can style</p></section></section></div><div class=\"col-3\"><section class=\"article-info\"><ul class=\"display-inline\"><li><button type=\"submit\" class=\"btn-editor\">");
jade_mixins["tick-icon"]();
buf.push("</button></li><li><button type=\"submit\" class=\"btn-editor cancel\">");
jade_mixins["close-icon"]();
buf.push("</button></li></ul></section></div>");
};
jade_mixins["article-info-editor-option"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<ul class=\"display-inline\"><li>");
jade_mixins["edit-button"]();
buf.push("</li><li>");
jade_mixins["save-button"]();
buf.push("</li><li>");
jade_mixins["share-button"]();
buf.push("</li></ul><section class=\"row__label\"><div class=\"label\">Relates to:</div></section><section class=\"row\"><ul class=\"display-inline\"><li><!--+show-icon('Technology', technology)--><span class=\"text\">" + (jade.escape(null == (jade_interp = technology) ? "" : jade_interp)) + "</span></li><li><!--+show-icon('Phase', phase)--></li><li><!--+show-icon('Type', type)--></li></ul></section><section class=\"row__label\"><div class=\"label\">Belongs to:</div></section><section class=\"row\"><ul><li><a href=\"/flare/curated-content\">");
jade_mixins["curated-content-icon"]();
buf.push("<span class=\"text\">Curated Content</span></a></li></ul></section><section class=\"row__label\"><div class=\"label\">Related Articles:</div></section><section class=\"row\"><ul><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li><li><a href=\"#\">Article Headline</a></li></ul></section>");
};
...
jade_mixins["all-icon"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<span title=\"Technology Independent\" class=\"icon-All\"><span class=\"path1\"></span><span class=\"path2\"></span></span>");
};
...
jade_mixins["curated-content-icon"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<span class=\"icon-Curated-Content\"></span>");
};
...
jade_mixins["all-icon"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<span class=\"icon-All\"><span class=\"path1\"></span><span class=\"path2\"></span></span>");
};
jade_mixins["android-icon"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<span class=\"icon-Android\"><span class=\"path1\"></span><span class=\"path2\"></span><span class=\"path3\"></span><span class=\"path4\"></span></span>");
...
jade_mixins["save-button"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<button title=\"Save article to Collection\" class=\"btn-result icon-Save\"></button>");
};
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<button title=\"Share all articles\" class=\"btn-result icon-Share\"></button>");
};
...
jade_mixins["edit-button"] = jade_interp = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<button type=\"submit\" id=\"btn-edit\" class=\"btn-result icon-Edit\"></button>");
};
...
buf.push("<aside ng-controller=\"User_Navigation_Controller\"><ul><li><div class=\"application-logo\"></div></li><li><a ui-sref=\"main\">");
jade_mixins["home-icon"]();
buf.push("</a></li><li><!--a(ui-sref=\"queries\")+index-icon--><a ng-click=\"open_Query_State()\">");
...
buf.push("</a><!--a(ui-sref=\"logout\")--></li></ul></aside><main>");
...
function jade_article_view_editor_option(locals) {
var buf = [];
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (technology) {
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div class=\"col-9\"><section class=\"article-body\"><section class=\"row__article\"><h1>Article Title</h1></section></section></div><div class=\"col-3\"><section class=\"article-info\">");
jade_mixins["article-info-editor-option"]();
...
buf.push("<div class=\"application\"><!--include ../component/left_navigation.jade--><main><section class=\"row\"><div class=\"col-3\"><dl><dt><div class=\"label\">Curated Content</div><span class=\"sub-nav__icon\">");
jade_mixins["back-icon"]();
...
buf.push("</a></li><li><a href=\"/angular/guest/index\">");
jade_mixins["logout-icon"]();
buf.push("</a><!--a(ui-sref=\"logout\")--></li></ul></aside><main><section class=\"row\"><section class=\"row__label\"><div class=\"label\">Popular Search Terms</div></section><section class=\"row\"><!-- Application Icons-->");
...
buf.push("</span></section></section></main></div></body></html>");}.call(this,"results" in locals_for_with?locals_for_with.results:typeof results!=="undefined"?results:undefined,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined));;return buf.join("");
}
...
buf.push("<main ng-controller=\"Navigate_Controller\"><section class=\"row\"><div class=\"col-3\"><navigate-queries></navigate-queries></div><div class=\"col-6\"><section class=\"row__label\"><div id=\"resultsTitle\" class=\"label no-underline\"># results showing</div></section><!--if resultssection.row__label\n  if results.size() > 25\n    .label.no-underline#resultsTitle= results.take(25).size() + '/' + results.size() + ' results showing'\n  else\n    .label.no-underline#resultsTitle= results.take(25).size() + ' results showing'\n  ul.display-inline\n    li\n      //a.button.btn-result.icon-Filter(href='#right-nav') aaaaaaa\n      a.button.btn-result.icon-Filter(href='')\n    //li\n      +save-results-button\n    //li\n      +share-results-button--><navigate-results></navigate-results></div><!--.col-3--><!--  filters--></section></main>");;return buf.join("");
}
...
jade_mixins["alert-pwd-sent"]();
buf.push("<login-form></login-form></section></div></section>");}.call(this,"viewModel" in locals_for_with?locals_for_with.viewModel:typeof viewModel!=="undefined"?viewModel:undefined));;return buf.join("");
}
...
buf.push("</a></li><li><a href=\"/angular/guest/index\">");
jade_mixins["logout-icon"]();
buf.push("</a><!--a(ui-sref=\"logout\")--></li></ul></aside><main><section class=\"row__label\"><div id=\"resultsTitle\" class=\"label no-underline\"># results showing</div></section><!--if resultssection.row__label\n  if results.size() > 25\n    .label.no-underline#resultsTitle= results.take(25).size() + '/' + results.size() + ' results showing'\n  else\n    .label.no-underline#resultsTitle= results.take(25).size() + ' results showing'\n  ul.display-inline\n    li\n      //a.button.btn-result.icon-Filter(href='#right-nav') aaaaaaa\n      a.button.btn-result.icon-Filter(href='')\n    //li\n      +save-results-button\n    //li\n      +share-results-button--><section class=\"row\"><span id=\"result_article\">");
if ( results)
{
// iterate results.take(10)
;(function(){
...
buf.push("</span></section></main></div></body></html>");}.call(this,"results" in locals_for_with?locals_for_with.results:typeof results!=="undefined"?results:undefined,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined));;return buf.join("");
}
...
var jade_interp;
;var locals_for_with = (locals || {});(function (technology) {
buf.push("<!--extends ../_to_be_wired_in/_layouts/page_logged_in--><!-- Application Icons-->");
...
buf.push("<div class=\"application\"><!--include ../component/left_navigation.jade--><main><section class=\"row\"><div class=\"col-3\"><!-- Application Icons-->");
